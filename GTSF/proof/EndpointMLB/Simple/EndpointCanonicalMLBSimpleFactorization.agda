module proof.EndpointMLB.Simple.EndpointCanonicalMLBSimpleFactorization where
...
open proof.EndpointMLB.Simple.EndpointCanonicalMLBSimplePairedSpan.SpanCtx using
...
open proof.EndpointMLB.Simple.EndpointCanonicalMLBSimplePermutation.CommonTransport using
  (transport-var; transport-star)
open import proof.Core.Permutation.ForallPermutationProperties using (swap01-pres-<)
