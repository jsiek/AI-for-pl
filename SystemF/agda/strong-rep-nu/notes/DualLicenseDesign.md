...
New CONTEXT entry form (TyEntry, strong-rep-nu/Context.agda):
...
Boundary well-formedness  Γ ∣ Ψ ⊢ Θ  (strong-rep-nu/Boundary.agda) — one new
...
The dual construction (entᴳ/cncOfRevs in strong-rep-nu/BReduction.agda, feeding the
