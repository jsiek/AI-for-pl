...
checkpoint₁-alpha-ok :
  CanRebaseSourceᵗ
    ...
    (toRenameᵗ (ηᴿᶜ checkpoint₁-outside-world)
      (Fin.suc Fin.zero))
checkpoint₁-alpha-ok =
  can-rebase-sourceᵗ (λ ())
...
checkpoint₁-beta-ok :
  CanRebaseSourceᵗ
    ...
    (toRenameᵗ (ηᴿᶜ checkpoint₁-alpha-current) Fin.zero)
checkpoint₁-beta-ok =
  can-rebase-sourceᵗ (λ ())
...
checkpoint₁-ladder-pinned : checkpoint₁-ladder ≡ "⟨X: ─ ⊑[X⊑★] X′↦＇Y′ │ Y: ─ ⊑[X⊑★] Y′↦★⟩\nsource term                      A           ηᴸA         ⊑ costs                              ηᴿB      B         target term\n───────────────────────────────  ──────────  ──────────  ───────────────────────────────────  ───────  ────────  ─────────────────────\n□₁ · □₂                          ℕ           ℕ           ℕ⊑ℕ                                  ℕ        ℕ         □₁ · □₂\n├ λ♯0. □                         (ℕ ⇒ ℕ)     (ℕ ⇒ ℕ)     ℕ⊑ℕ, ℕ⊑ℕ                             (ℕ ⇒ ℕ)  (ℕ ⇒ ℕ)   λ♯0. □\n│ ♯0                             ℕ           ℕ           ℕ⊑ℕ                                  ℕ        ℕ         ♯0\n└ □ ⟨ ★↦ℕ ⟩                      ℕ           ℕ           ℕ⊑ℕ                                  ℕ        ℕ         □ ⟨ ★↦ℕ ⟩\n  □₁ · □₂                        ★           ★           ★⊑★                                  ★        ★         □₁ · □₂\n  ├ □ [ ℕ ]                      (ℕ ⇒ ★)     (ℕ ⇒ ★)     ι⊑★, ★⊑★                             (★ ⇒ ★)  (★ ⇒ ★)   ─\n  │ □ ⟨ ∀ (♭0 ⇒ ★)↦∀ (♭0 ⇒ ★) ⟩  ∀ (♭0 ⇒ ★)  ∀ (♭0 ⇒ ★)  ∀⊑(mark X⊑★ at ♭0, ★⊑★)              (★ ⇒ ★)  (★ ⇒ ★)   □ ⟨ (★ ⇒ ★)↦(★ ⇒ ★) ⟩\n  │ Λ□                           ∀ (♭0 ⇒ ★)  ∀ (♭0 ⇒ ★)  ∀⊑(mark X⊑★ at ♭0, ★⊑★)              (★ ⇒ ★)  (★ ⇒ ★)   ─\n  │ ─                            (♭0 ⇒ ★)    (♭0 ⇒ ★)    mark X⊑★ at ♭0, ★⊑★ + source rebase  (★ ⇒ ★)  (★ ⇒ ★)   □ ↑ ⇒-rev\n  │ ─                            (♭0 ⇒ ★)    (Y ⇒ ★)     Y ≈ Y, ★⊑★ + source rebase           (Y ⇒ ★)  (Y′ ⇒ ★)  □ ↑ ⇒-rev\n  │ λ♯0. □                       (♭0 ⇒ ★)    (X ⇒ ★)     X ≈ X, ★⊑★                           (X ⇒ ★)  (X′ ⇒ ★)  λ♯0. □\n  │ □₁ · □₂                      ★           ★           ★⊑★                                  ★        ★         □₁ · □₂\n  │ ├ λ♯1. □                     (★ ⇒ ★)     (★ ⇒ ★)     ★⊑★, ★⊑★                             (★ ⇒ ★)  (★ ⇒ ★)   λ♯1. □\n  │ │ ♯1                         ★           ★           ★⊑★                                  ★        ★         ♯1\n  │ └ □ ⟨ ♭0↦★ ⟩                 ★           ★           ★⊑★                                  ★        ★         □ ⟨ X′↦★ ⟩\n  │   ♯0                         ♭0          X           X ≈ X                                X        X′        ♯0\n  └ □ ⟨ ℕ↦ℕ ⟩                    ℕ           ℕ           ι⊑★                                  ★        ★         □ ⟨ ℕ↦★ ⟩\n    42                           ℕ           ℕ           ℕ⊑ℕ                                  ℕ        ℕ         42"
checkpoint₁-ladder-pinned = refl
...
checkpoint₃-alpha-ok :
  CanRebaseSourceᵗ
    ...
    (toRenameᵗ (ηᴿᶜ checkpoint₃-allocation-world)
      (Fin.suc Fin.zero))
checkpoint₃-alpha-ok =
  can-rebase-sourceᵗ (λ ())
    (insert-skipᵗ (insert-skipᵗ insert-hereᵗ))
...
checkpoint₃-beta-ok :
  CanRebaseSourceᵗ
    ...
    (toRenameᵗ (ηᴿᶜ checkpoint₃-world) Fin.zero)
checkpoint₃-beta-ok =
...
checkpoint₈-ladder-pinned : checkpoint₈-ladder ≡ "⟨X: ─ ⊑[X⊑★] ─ │ Y: X↦ℕ ⊑[X⊑★] X′↦＇Y′ │ Z: ─ ⊑[X⊑★] Y′↦★⟩\nsource term     A        ηᴸA      ⊑ costs                          ηᴿB      B        target term\n──────────────  ───────  ───────  ───────────────────────────────  ───────  ───────  ───────────\n□₁ · □₂         ℕ        ℕ        ℕ⊑ℕ                              ℕ        ℕ        □₁ · □₂\n├ λ♯0. □        (ℕ ⇒ ℕ)  (ℕ ⇒ ℕ)  ℕ⊑ℕ, ℕ⊑ℕ                         (ℕ ⇒ ℕ)  (ℕ ⇒ ℕ)  λ♯0. □\n│ ♯0            ℕ        ℕ        ℕ⊑ℕ                              ℕ        ℕ        ♯0\n└ □ ⟨ ★↦ℕ ⟩     ℕ        ℕ        ℕ⊑ℕ                              ℕ        ℕ        □ ⟨ ★↦ℕ ⟩\n  □ ⟨ ★↦★ ⟩     ★        ★        ★⊑★                              ★        ★        □ ⟨ ★↦★ ⟩\n  ─             ★        ★        ★⊑★ + generator absent           ★        ★        □ ↑ id\n  ─             ★        ★        ★⊑★ + generator absent           ★        ★        □ ↑ id\n  □ ↑ id        ★        ★        ★⊑★ + generator absent           ★        ★        ─\n  □₁ · □₂       ★        ★        ★⊑★                              ★        ★        □₁ · □₂\n  ├ λ♯0. □      (★ ⇒ ★)  (★ ⇒ ★)  ★⊑★, ★⊑★                         (★ ⇒ ★)  (★ ⇒ ★)  λ♯0. □\n  │ ♯0          ★        ★        ★⊑★                              ★        ★        ♯0\n  └ □ ⟨ X↦★ ⟩   ★        ★        ★⊑★                              ★        ★        □ ⟨ X′↦★ ⟩\n    ─           X        Y        Y ≈ Y + source rebase            Y        X′       □ ↓ seal X′\n    □ ↓ seal X  X        Z        Z ≈ Z + matched conceal partner  Z        Y′       □ ↓ seal Y′\n    ─           ℕ        ℕ        ι⊑★                              ★        ★        □ ⟨ ℕ↦★ ⟩\n    42          ℕ        ℕ        ℕ⊑ℕ                              ℕ        ℕ        42"
checkpoint₈-ladder-pinned = refl
