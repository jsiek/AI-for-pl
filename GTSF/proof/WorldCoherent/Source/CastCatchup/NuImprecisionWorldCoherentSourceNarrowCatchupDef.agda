module proof.WorldCoherent.Source.CastCatchup.NuImprecisionWorldCoherentSourceNarrowCatchupDef where

-- File Charter:
--   * Defines world-coherent catch-up for one source narrowing cast.
...
WorldCoherentSourceNarrowCatchupᵀ : Set₁
