...
-- File Charter:
--   * Defines the three live paired outer-cast value roots when the source
--     cast is inert.
...
--   * Contains no implementation, active-source synchronization, quotient
--     case, dispatcher, postulate, hole, or permissive option.
...
record WorldCoherentRightOneStepPairedSourceInertValueRootᵀ : Set₁ where
  field
...
open WorldCoherentRightOneStepPairedSourceInertValueRootᵀ public
