module proof.Core.Properties.CoercionProperties where
...
--     preservation.
--   * Store-specific lemmas belong in `proof.Core.Properties.StoreProperties`.
--   * Term substitution/renaming lemmas belong in `proof.Core.Properties.NuTermProperties`.
