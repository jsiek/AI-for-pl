...
preservation-step {Δ = Δ} {Ψ = Ψ} {Σ = Σ} {Γ = Γ} uΣ
  ...
  where
    ...
    p⊢↑ =
      wk⊒
        (drop ⊆ˢ-refl)
        (⊒-renameˢ-wt suc RenOk-suc RenOkConv-suc RenOkCast-suc RenOkTag-suc RenNotIn-suc p⊢)
...
preservation-step uΣ (⊢· L⊢ M⊢) (ξ-·₁ red)
  | Ψ′ , hρ , L′⊢ | shape-id =
    ...
    ⊢·
      ...
      (wkΣ-term
        (store-growth red)
        (renameˢ-wt idˢ hρ (λ Φ → Φ) RenOk-id RenOkConv-id RenOkCast-id RenOkTag-id RenNotIn-id M⊢))
preservation-step uΣ (⊢· L⊢ M⊢) (ξ-·₁ red)
  | Ψ′ , hρ , L′⊢ | shape-suc =
    Ψ′ , hρ ,
    ⊢·
      ...
      (wkΣ-term
        (store-growth red)
        (renameˢ-wt suc hρ mapΦ-suc RenOk-suc RenOkConv-suc RenOkCast-suc RenOkTag-suc RenNotIn-suc M⊢))
...
preservation-step uΣ (⊢· L⊢ M⊢) (ξ-·₂ vV red)
  | Ψ′ , hρ , M′⊢ | shape-id =
    ...
    ⊢·
      (wkΣ-term
        (store-growth red)
        (renameˢ-wt idˢ hρ (λ Φ → Φ) RenOk-id RenOkConv-id RenOkCast-id RenOkTag-id RenNotIn-id L⊢))
      M′⊢
preservation-step uΣ (⊢· L⊢ M⊢) (ξ-·₂ vV red)
  | Ψ′ , hρ , M′⊢ | shape-suc =
    Ψ′ , hρ ,
    ⊢·
      (wkΣ-term
        (store-growth red)
        (renameˢ-wt suc hρ mapΦ-suc RenOk-suc RenOkConv-suc RenOkCast-suc RenOkTag-suc RenNotIn-suc L⊢))
      M′⊢
...
preservation-step uΣ (⊢up Φ M⊢ hp) (ξ-up red)
  | Ψ′ , hρ , M′⊢ | shape-id =
    ...
    ⊢up
      ...
      (wk⊑
        (store-growth red)
        (⊑-renameˢ-wt idˢ RenOk-id RenOkConv-id RenOkCast-id RenOkTag-id RenNotIn-id hp))
preservation-step uΣ (⊢up Φ M⊢ hp) (ξ-up red)
  | Ψ′ , hρ , M′⊢ | shape-suc =
    Ψ′ , hρ ,
    ⊢up
      ...
      (wk⊑
        (store-growth red)
        (⊑-renameˢ-wt suc RenOk-suc RenOkConv-suc RenOkCast-suc RenOkTag-suc RenNotIn-suc hp))
