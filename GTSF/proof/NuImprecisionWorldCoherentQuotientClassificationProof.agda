...
world-coherent-quotient-outer-pureᵀ :
  ...
  ⊎ ∃[ B ] ∃[ s ]
      ...
      Value V × No• V
world-coherent-quotient-outer-pureᵀ
    coherent wfL (β-id vW) vV noV vV′ noV′
...
world-coherent-quotient-outer-pureᵀ
  ...
  inj₁ (⊥-elim
    (source-inert-quotient-down-before-id-widening-impossible
      vW down u⊑))
world-coherent-quotient-outer-pureᵀ
    coherent wfL (β-seq vW) vV noV vV′ noV′
    inert-d′ inert-u′ down
...
world-coherent-quotient-outer-pureᵀ
  ...
  inj₁ (⊥-elim
    (source-inert-quotient-down-var-impossible vW down))
world-coherent-quotient-outer-pureᵀ
    coherent wfL (β-inst vW) vV noV vV′ noV′
    inert-d′ inert-u′ down
    (quotient-id-widening
      (C.cast-inst hB occ s⊢ , NW.inst sʷ)
      u′⊑)
    pA =
  inj₂ (_ , _ , refl , outer-inst-allocation-trace noV vW , vV , noV)
world-coherent-quotient-outer-pureᵀ
    coherent wfL (β-inst vW) vV noV vV′ noV′
    inert-d′ inert-u′ down
  ...
  inj₂ (_ , _ , refl , outer-inst-allocation-trace noV vW , vV , noV)
world-coherent-quotient-outer-pureᵀ
    coherent wfL (tag-untag-ok vW) vV noV vV′ noV′
    inert-d′ inert-u′ down
...
world-coherent-quotient-outer-pureᵀ
  ...
  inj₁ (⊥-elim (source-quotient-down-tag-impossible down))
world-coherent-quotient-outer-pureᵀ
    coherent wfL (tag-untag-bad vW G≢H) vV noV vV′ noV′
    inert-d′ inert-u′ down
    (quotient-id-widening u⊑ u′⊑) pA =
  inj₁ (⊥-elim (source-quotient-down-tag-impossible down))
world-coherent-quotient-outer-pureᵀ
  ...
  inj₁ (⊥-elim (source-quotient-down-tag-impossible down))
world-coherent-quotient-outer-pureᵀ
    coherent wfL (seal-unseal vW) vV noV vV′ noV′
    inert-d′ inert-u′ down
    (quotient-id-widening u⊑ u′⊑) pA =
...
world-coherent-quotient-inner-stepᵀ :
  ...
  WorldCoherentLeftCatchupIndexedResult
    ...
    {ρ = ρ} pA
world-coherent-quotient-inner-stepᵀ
    coherent wfL (pure-step (β-id vW)) vV noV vV′ noV′
    inert-d′ inert-u′ down widening pA =
  ⊥-elim
    (target-inert-quotient-down-after-source-id-impossible
      inert-d′ down)
world-coherent-quotient-inner-stepᵀ
    coherent wfL (pure-step (β-seq vW)) vV noV vV′ noV′
...
world-coherent-quotient-inner-stepᵀ
  ...
  ⊥-elim (source-quotient-down-seal-tail-impossible down)
world-coherent-quotient-inner-stepᵀ
    coherent wfL (pure-step (β-inst vW)) vV noV vV′ noV′
    inert-d′ inert-u′
...
world-coherent-quotient-inner-stepᵀ
  ...
  world-coherent-left-indexed-catchup
    ...
    wfL
world-coherent-quotient-inner-stepᵀ
    coherent wfL (pure-step (seal-unseal vW))
    vV noV vV′ noV′ inert-d′ inert-u′ down widening pA =
  ⊥-elim (source-quotient-down-unseal-impossible down)
world-coherent-quotient-inner-stepᵀ
    coherent wfL (pure-step blame-⟨⟩) () noV vV′ noV′
    inert-d′ inert-u′ down widening pA
world-coherent-quotient-inner-stepᵀ
    coherent wfL (ξ-⟨⟩ V→) vV noV vV′ noV′
    inert-d′ inert-u′ down widening pA =
...
world-coherent-quotient-after-source-stepᵀ :
  ...
  ⊎ ∃[ B ] ∃[ s ]
      ...
      Value V × No• V
world-coherent-quotient-after-source-stepᵀ
    coherent wfL vV noV vV′ noV′ inert-d′ inert-u′
    (pure-step source→) down widening pA =
  world-coherent-quotient-outer-pureᵀ {pA = pA}
    coherent wfL source→ vV noV vV′ noV′
    inert-d′ inert-u′ down widening pA
world-coherent-quotient-after-source-stepᵀ
    coherent wfL vV noV vV′ noV′ inert-d′ inert-u′
...
world-coherent-quotient-classification-proofᵀ {pA = pA}
    coherent wfL vV′ noV′ inert-d′ inert-u′
