module proof.EndpointCanonicalMLBSimpleCompleteness where
...
open import proof.TypeProperties using (occurs-extsNᵗ-below; occurs-suc-var)
...
close-star-lowerᵢ :
  ...
  WfTy (suc Δ) A →
  idᵢ Δ ∣ Δ ⊢ `∀ A ⊑ A [ ★ ]ᵗ ⊣ Δ
close-star-lowerᵢ occA hA = ν occA (star-inst-lowerᵢ hA)
