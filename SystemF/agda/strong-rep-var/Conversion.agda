module strong-rep-var.Conversion where
...
-- (conv-id / conv-idv) and by the classification in strong-rep-var.Terms
-- (A-idb
...
-- `_⊢_≈_⊣_` (strong-rep-var.Ctx §5) relates two ordinary spellings of ONE
...
-- (`∋:=-ren`, strong-rep-var.proof.Ctx §3).
