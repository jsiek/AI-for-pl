...
-- moved into the core:
--
--   * strong.CtxMorph §3b proves (Q): the conversion contexts on the two
--     sides of a crossing name the same representation variables;
--   * strong.CtxMorph §3c constructs the dual's conversion context;
--   * strong.Conversion §2c re-spells a well-typed conversion and exports
...
open import strong.Types using (`ℕ; `𝔹)
