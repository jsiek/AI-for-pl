...
Add `proof.Core.Permutation.ForallPermutationProperties` with small structural lemmas needed by
the later proofs.
...
```text
python3 -m unittest proof.EndpointMLB.Python.test_endpoint_canonical_mlb_simple
agda -v0 proof/Core/Permutation/ForallPermutationProperties.agda
agda -v0 proof/EndpointMLB/Simple/EndpointCanonicalMLBSimpleCompleteness.agda
agda -v0 proof/EndpointMLB/Simple/EndpointCanonicalMLBSimpleMaximality.agda
agda -v0 proof/EndpointMLB/Simple/EndpointCanonicalMLBSimplePermutation.agda
agda -v0 proof/EndpointMLB/Simple/EndpointCanonicalMLBSimpleQuotient.agda
agda -v0 proof/Compilation/CompileTermImprecision.agda
agda -v0 All.agda
```
