...
taplConstApp : Term
taplConstApp = (((taplConst ·[ `Bool ]) ·[ `ℕ ]) · `true) · `zero
...
doubleOnSuccZero = ((double ·[ `ℕ ]) · succFn) · `zero
...
selfApp : Term
selfApp = ((((identity ·[ `∀ (` 0 ⇒ ` 0) ]) · identity) ·[ `Bool ]) · `true)
...
nil-⊢ =
  ⊢Λ
    (⊢Λ
      (⊢ƛ (wfFn wfTy1₂ (wfFn wfTy0₂ wfTy0₂))
        (⊢ƛ wfTy0₂ (⊢` Z))))

cons : Term
cons = Λ (ƛ[ (` 0) ] (ƛ[ (List (` 0)) ] (Λ (ƛ[ (` 1 ⇒ ` 0 ⇒ ` 0) ] (ƛ[ (` 0) ] ((` 1 · ` 3) · (((` 2 ·[ ` 0 ]) · ` 1) · ` 0)))))))
...
isnil : Term
isnil = Λ (ƛ[ (List (` 0)) ] (((` 0 ·[ `Bool ]) · (ƛ[ (` 0) ] (ƛ[ `Bool ] `false))) · `true))
...
nilIsNil-↠ =
  ...
  ((ƛ[ (List `Bool) ] (((` 0 ·[ `Bool ]) · (ƛ[ `Bool ] (ƛ[ `Bool ] `false))) · `true)) · (nil ·[ `Bool ]))
    —→⟨ ξ-·₂ vLam (β-Λ {A = `Bool}) ⟩
  ((ƛ[ (List `Bool) ] (((` 0 ·[ `Bool ]) · (ƛ[ `Bool ] (ƛ[ `Bool ] `false))) · `true)) · (Λ (ƛ[ (`Bool ⇒ ` 0 ⇒ ` 0) ] (ƛ[ (` 0) ] (` 0)))))
    —→⟨ β-ƛ vTlam ⟩
  ((((Λ (ƛ[ (`Bool ⇒ ` 0 ⇒ ` 0) ] (ƛ[ (` 0) ] (` 0))) ) ·[ `Bool ]) · (ƛ[ `Bool ] (ƛ[ `Bool ] `false))) · `true)
    —→⟨ ξ-·₁ (ξ-·₁ (β-Λ {A = `Bool})) ⟩
  (((ƛ[ (`Bool ⇒ `Bool ⇒ `Bool) ] (ƛ[ `Bool ] (` 0))) · (ƛ[ `Bool ] (ƛ[ `Bool ] `false))) · `true)
    —→⟨ ξ-·₁ (β-ƛ vLam) ⟩
  ((ƛ[ `Bool ] (` 0)) · `true) —→⟨ β-ƛ vTrue ⟩
  `true ∎
...
fst-⊢ =
  ⊢Λ
    (⊢Λ
      (⊢ƛ (wf`∀ (wfFn (wfFn wfTy2₃ (wfFn wfTy1₃ wfTy0₃)) wfTy0₃))
        (⊢·
          (⊢·[] {A = ((` 2 ⇒ ` 1 ⇒ ` 0) ⇒ ` 0)} {B = ` 1}
            (⊢` Z)
            wfTy1₂)
...
ex-xi-tapp : Term
ex-xi-tapp = ((`if_then_else `true polyId polyId) ·[ `Bool ]) · `true
