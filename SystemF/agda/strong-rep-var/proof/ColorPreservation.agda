module strong-rep-var.proof.ColorPreservation where

-- COLOR PRESERVATION — the proof (statement approved by Jeremy,
-- 2026-09-21; strong-rep-var.ColorPreservation states it publicly).
--
...
-- strong-rep-var.Boundary §3a supply the new boundary frames' readings:
...
open import strong-rep-var.proof.RepWeaken using (repwk-wkN; wkN-+)
open import strong-rep-var.proof.Preserve
  using (empty-interior; instantiate-boundarywf)
open import strong-rep-var.Preservation using (preservation)
