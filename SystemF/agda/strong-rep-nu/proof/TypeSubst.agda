module strong-rep-nu.proof.TypeSubst where
...
--     `exts-sub-cons`.
--   * NO DEFINITIONS (strong-rep-nu.Types), and no single-index
--     facts (strong-rep-nu.proof.Types).  Nothing here mentions a
