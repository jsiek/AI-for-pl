module DoubleInterpreterCatchUp where

-- File Charter:
--   * Proves that the single-sided loops in `DoubleInterpreter` find every
...
open import InterpreterDynamicGradualGuaranteeDirect using
