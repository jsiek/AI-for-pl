...
--     source-`ν` `av-∀`/`av-∀` value case.
--   * Retains the whole paired cast because no intermediate one-sided type
--     relation is available in general.
...
WorldCoherentSourceNuPairedAllTargetClosingCatchupᵀ : Set₁
