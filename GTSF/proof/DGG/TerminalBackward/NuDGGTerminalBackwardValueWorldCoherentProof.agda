module proof.DGG.TerminalBackward.NuDGGTerminalBackwardValueWorldCoherentProof where
...
open import proof.DGG.TerminalBackward.NuDGGTerminalBackwardValueWorldCoherentDef using
