module strong-rep-nu.notes.ForallPayloadWall where
...
--     (strong-rep-nu.Reduction; notes/DECISIONS.md, 2026-09-18), and the two
--     programs that found it run: they are §6a and §6b of
--     strong-rep-nu.Examples.
--
