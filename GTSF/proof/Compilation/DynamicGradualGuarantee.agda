...
module proof.Compilation.DynamicGradualGuarantee where
...
open import proof.Substitution.Term.TermSubstitutionNarrowing using
  (term-substitution-narrowingᵗ)
open import proof.Core.Properties.NuTermProperties using (renameᵗᵐ-reflects-Value)
open import proof.DGG.Core.NuProgress using (canonical-ℕ; NatView; nv-const)
