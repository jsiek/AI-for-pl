...
(emptyRelSub .ρ₁) = idᵗ
(emptyRelSub .ρ₂) = idᵗ
(emptyRelSub .ρR) = λ α V W x x₁ → ⊥ -- wild guess! -Jeremy

extendRelSub : (ρ : RelSub)
  → (A₁ A₂ : Ty)
  → Rel A₁ A₂
  → RelSub
(extendRelSub ρ A₁ A₂ R) .ρ₁        = A₁ •ᵗ ρ₁ ρ
(extendRelSub ρ A₁ A₂ R) .ρ₂        = A₂ •ᵗ ρ₂ ρ
(extendRelSub ρ A₁ A₂ R) .ρR 0      = R
(extendRelSub ρ A₁ A₂ R) .ρR (suc α)  = ρR ρ α
