module proof.EndpointMLB.Core.MaximalLowerBoundsWfExperiment where

-- WARNING:
--   This is an obsolete experiment, not the current MLB coherence plan.
--   The route-coherence postulate below is refuted by
--   `proof.EndpointMLB.Core.MLBGlbCounterexample.bad-selector-coherence-counterexampleᵢ`
...
--   in `GTSF/proof/EndpointMLB/Core/EndpointCanonicalMLBDesign.md`.
