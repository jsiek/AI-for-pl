module strong.proof.AddLock0 where
...
--   the interior   `strong.proof.RepWeaken.⊢renᴿ` at `repwk-push` of the
...
--                  `strong.proof.PeelDual.respell-⊢` to move it onto the
...
-- `keep` component of `strong.CtxMorph.addLock0-conversion-ren`, transported
...
open import strong.proof.RepWeaken using (⊢renᴿ)
open import strong.proof.PeelDual using (respell-⊢)
