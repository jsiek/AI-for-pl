module proof.Quotient.QuotientedTermImprecisionTest where
...
open import proof.Core.Permutation.ForallPermutationTest using (glb-lower-XY⊑ᵖYX)
open import proof.EndpointMLB.Core.MLBGlbExample using
  (glb-bad-A; glb-bad-A⊑A; glb-bad-B; glb-bad-B⊑B)
open import proof.EndpointMLB.Core.MLBRouteOperationalExperiment using
  ( down-D
  ; down-D-⊒
  ; down-E
  ; down-E-⊒
