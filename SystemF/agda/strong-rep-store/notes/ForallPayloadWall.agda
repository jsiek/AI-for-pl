module strong-rep-store.notes.ForallPayloadWall where
...
--     (strong-rep-store.Reduction; notes/DECISIONS.md, 2026-09-18), and the two
...
-- (strong-rep-store.proof.Ctx), which
