module proof.EndpointMLB.Simple.EndpointCanonicalMLBSimplePermutation where
...
data AlignedRoutes :
  ...
  aligned-vars :
    ∀ {fuel Φᴸ Φᴿ Δᶜ Δᴸ Δᴿ X Y C}
      {C∈ C∈′ :
        C ∈ proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.varCandidatesUpTo
          Φᴸ Φᴿ (＇ X) (＇ Y) Δᶜ} →
    AlignedRoutes
      (route-vars
...
no-∀ctx-zero-star :
  ∀ {Φ} →
  (zero ˣ⊑★) ∈ proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.∀ᵢᶜ Φ →
  ⊥
...
un∀-star :
  ∀ {Φ X} →
  (suc X ˣ⊑★) ∈ proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.∀ᵢᶜ Φ →
  (X ˣ⊑★) ∈ Φ
un∀-star (here ())
...
no-νctx-zero-var :
  ∀ {Φ Y} →
  (zero ˣ⊑ˣ Y) ∈ proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.νᵢᶜ Φ →
  ⊥
...
unν-var :
  ∀ {Φ X Y} →
  (suc X ˣ⊑ˣ Y) ∈ proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.νᵢᶜ Φ →
  (X ˣ⊑ˣ Y) ∈ Φ
unν-var (here ())
...
unν-star :
  ∀ {Φ X} →
  (suc X ˣ⊑★) ∈ proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.νᵢᶜ Φ →
  (X ˣ⊑★) ∈ Φ
unν-star (here ())
...
transport-∀ :
  ...
  CommonTransport (extᵗ ρ)
    (proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.∀ᵢᶜ Φ)
    (proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.∀ᵢᶜ Ψ)
...
transport-ν :
  ...
  CommonTransport (extᵗ ρ)
    ...
    (proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.νᵢᶜ Ψ)
...
∀ctx-var-source-functional :
  ∀ {Φ} →
  VarSourceFunctional Φ →
  VarSourceFunctional (proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.∀ᵢᶜ Φ)
...
νctx-var-source-functional :
  ∀ {Φ} →
  VarSourceFunctional Φ →
  VarSourceFunctional (proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.νᵢᶜ Φ)
...
∀ctx-var-target-injective :
  ∀ {Φ} →
  VarTargetInjective Φ →
  VarTargetInjective (proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.∀ᵢᶜ Φ)
...
νctx-var-target-injective :
  ∀ {Φ} →
  VarTargetInjective Φ →
  VarTargetInjective (proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.νᵢᶜ Φ)
...
flip-enum-route {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {A = ＇ X} {B = ＇ Y}
    ...
    with andᵇ-true
      {a = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasVar W X Φᴸ}
      {b = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasVar W Y Φᴿ} ok
flip-enum-route {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {A = ＇ X} {B = ＇ Y}
    (route-vars C∈) | W , refl , W<Δ , ok
    | W⊑X , W⊑Y =
  route-vars
...
flip-enum-route {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {A = ＇ X} {B = ★}
    ...
    with andᵇ-true
      {a = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasVar W X Φᴸ}
      {b = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasStar W Φᴿ} ok
flip-enum-route {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {A = ＇ X} {B = ★}
    (route-var-star C∈) | W , refl , W<Δ , ok
    | W⊑X , W⊑★ =
  route-star-var
...
flip-enum-route {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {A = ★} {B = ＇ Y}
    ...
    with andᵇ-true
      {a = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasStar W Φᴸ}
      {b = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasVar W Y Φᴿ} ok
flip-enum-route {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {A = ★} {B = ＇ Y}
    (route-star-var C∈) | W , refl , W<Δ , ok
    | W⊑★ , W⊑Y =
...
left-used-path {modes = modes} {Δ = Δ} {X = X} origin
    ...
    | W , (refl , (W<limit , candidate))
    with andᵇ-true
      {a = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasVar
        W y (apply-left modes (idᵢ Δ))}
      {b = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasVar
...
left-used-path {modes = modes} {Δ = Δ} {X = X} origin
    ...
    | W , (refl , (W<limit , candidate))
    with andᵇ-true
      {a = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasStar
...
right-used-path {modes = modes} {Δ = Δ} {X = X} origin
    ...
    with andᵇ-true
      {a = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasVar
        W y (apply-left modes (idᵢ Δ))}
      {b = proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple.hasStar
