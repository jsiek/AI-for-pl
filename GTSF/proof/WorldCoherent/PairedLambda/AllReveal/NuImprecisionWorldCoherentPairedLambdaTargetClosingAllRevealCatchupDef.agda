...
-- File Charter:
--   * Defines target-binder closing for the structural `reveal-all` branch
--     after one source-only allocation.
--   * Exposes the nested reveal and paired body relation without choosing a
--     recursive proof or binder-rotation implementation.
...
WorldCoherentPairedLambdaTargetClosingAllRevealCatchupᵀ : Set₁
