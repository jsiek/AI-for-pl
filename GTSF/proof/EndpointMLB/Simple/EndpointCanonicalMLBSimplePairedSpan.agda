module proof.EndpointMLB.Simple.EndpointCanonicalMLBSimplePairedSpan where
...
open import proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple using (∀ᵢᶜ; νᵢᶜ)
