module proof.EndpointMLB.Simple.EndpointCanonicalMLBSimpleFactorCounterexample where
...
open import proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple using (rawEndpointMlbsAt)
