...
-- File Charter:
--   * Defines the structural core of the source-generic-frame paired-conceal
--     closing branch after both universal conceal conversions are inverted.
--   * Retains the recursive closing result, generic-frame relation, source
--     allocation, conversion correspondence, both inner conceals, and final
...
PairedLambdaTargetClosingSourceGenFrameStructuralConcealClosingᵀ : Set₁
