...
--     strong-rep-var.proof.Ctx; that split (notes/DECISIONS.md, 2026-09-20) is
--     why the sections here begin at 2, and other modules cite these
--     numbers, so do not renumber them.  The renamings that pair the
--     two universes (`renᴮ²`, `renᴹ²`, `renᴹᴿ`) are strong-rep-var.TermSubst,
...
open import strong-rep-var.Types using (Ty; `ℕ; Renameᵗ; renameᵗ)
...
-- tower example walked into (strong-rep-var.Examples §5a, `no-rewind-conv` /
