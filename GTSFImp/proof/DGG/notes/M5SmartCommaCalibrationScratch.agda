...
var-leaf : ∀ {Δᴸ Δᴿ Δ} {W : CTI2.World Δᴸ Δᴿ Δ}
    {A : Ty Δᴸ} {B : Ty Δᴿ}
  → (p : A CTI2.⊑ᵂ⟨ W ⟩ B)
  → W ∣ CTI2.ctx-imp A B p ∷ []
      ⊢² ` 0 ⊑ ` 0 ∶ p
var-leaf p = CTI2.x⊑x² CTI2.Zʷ
...
a0-e4-inner-rebaseᴿ :
  CTI2.RebaseAtᴿ (IIP.ΛPostMidWorld IL.base-world)
...
a0-e4-outer-rebaseᴿ :
  CTI2.RebaseAtᴿ
    (CTI2.liftWorldLeft I.X⊑★
      (CTI2.rightOnlyWorld
        (CTI2.rightOnlyWorld IL.base-world ★) (＇ Fin.zero)))
...
a1-e4-alias-world : CTI2.World 1 2 2
a1-e4-alias-world =
  CTI2.world η-src-β-1 η-tgt-βα-2 imp-alias-X-2
    e4-source-store target-store-βα

a1-e4-name-world : CTI2.World 1 2 2
a1-e4-name-world =
  CTI2.world η-src-α-1 η-tgt-βα-2 imp-alias-X-2
    e4-source-store target-store-βα

a1-e4-alias-WFWorld : CTI2.WFWorld a1-e4-alias-world
a1-e4-alias-WFWorld Fin.zero eq = target-β , refl

a1-e4-source-off-name-to-alias : ∀ {Y}
  → Y ≢ Fin.zero
  → toRenameᵗ (CTI2.ηᴸʷ a1-e4-name-world) Y
    ≡ toRenameᵗ (CTI2.ηᴸʷ a1-e4-alias-world) Y
a1-e4-source-off-name-to-alias {Fin.zero} neq = ⊥-elim (neq refl)

a1-e4-outer-rebaseᴿ :
  CTI2.RebaseAtᴿ a1-e4-alias-world a1-e4-name-world
    (just target-α)
a1-e4-outer-rebaseᴿ =
  CTI2.rebase-varᴿ
...
a1-e4-inner-rebase-refuted :
  CTI2.RebaseAtᴿ a1-e4-name-world a1-e4-alias-world
    (just target-β)
  → ⊥
a1-e4-inner-rebase-refuted
...
a1-e4-type-leaf-ok :
  e4-source-body CTI2.⊑ᵂ⟨ a1-e4-name-world ⟩ e4-target-name-body
a1-e4-type-leaf-ok = I.⇒⊑⇒ I.X⊑X I.X⊑X

a1-e4-term-var-p :
  ＇ Fin.zero CTI2.⊑ᵂ⟨ a1-e4-alias-world ⟩ ＇ target-β
a1-e4-term-var-p = I.X⊑X

a1-e4-term-var-leaf-ok :
  a1-e4-alias-world ∣
    CTI2.ctx-imp (＇ Fin.zero) (＇ target-β) a1-e4-term-var-p ∷ []
    ⊢² ` 0 ⊑ ` 0 ∶ a1-e4-term-var-p
a1-e4-term-var-leaf-ok = var-leaf a1-e4-term-var-p

a1-d1-alias-world : CTI2.World 2 2 3
a1-d1-alias-world = IL.candidate-world

a1-d1-name-world : CTI2.World 2 2 3
a1-d1-name-world =
  CTI2.world η-src-αℓ-2 η-tgt-βα-3 imp-alias-X-3
    d1-source-store target-store-βα

a1-d1-alias-WFWorld : CTI2.WFWorld a1-d1-alias-world
a1-d1-alias-WFWorld = IL.candidate-WFWorld

a1-d1-name-WFWorld : CTI2.WFWorld a1-d1-name-world
a1-d1-name-WFWorld Fin.zero ()
a1-d1-name-WFWorld (Fin.suc Fin.zero) ()

a1-d1-outer-rebaseᴿ :
  CTI2.RebaseAtᴿ a1-d1-alias-world a1-d1-name-world
    (just target-α)
a1-d1-outer-rebaseᴿ =
  CTI2.rebase-varᴿ
    (CTI2.rebase-at (CTI2.same-runtime refl refl)
  ...
  source-off : ∀ {Y}
    → Y ≢ Fin.zero
    → toRenameᵗ (CTI2.ηᴸʷ a1-d1-name-world) Y
      ≡ toRenameᵗ (CTI2.ηᴸʷ a1-d1-alias-world) Y
  source-off {Fin.zero} neq = ⊥-elim (neq refl)
  source-off {Fin.suc Fin.zero} neq = refl

a1-d1-inner-rebase-refuted :
  CTI2.RebaseAtᴿ a1-d1-name-world a1-d1-alias-world
    (just target-β)
  → ⊥
a1-d1-inner-rebase-refuted
    (CTI2.rebase-varᴿ {Xᴸ = Fin.zero} rb) =
  no-var⊑star-at-X⊑X refl
    (CTI2.StoreRepImp.represented
      (CTI2.RebaseAt.storeRepresentations rb))
a1-d1-inner-rebase-refuted
    (CTI2.rebase-varᴿ {Xᴸ = Fin.suc Fin.zero}
      (CTI2.rebase-at _ _ _ () _))

a1-d1-type-leaf-ok :
  d1-source-body CTI2.⊑ᵂ⟨ a1-d1-name-world ⟩ d1-target-name-body
a1-d1-type-leaf-ok = I.⇒⊑⇒ I.X⊑X I.★⊑★

a1-d1-term-var-p :
  ＇ Fin.zero CTI2.⊑ᵂ⟨ a1-d1-alias-world ⟩ ＇ target-β
a1-d1-term-var-p = I.X⊑X

a1-d1-term-var-leaf-ok :
  a1-d1-alias-world ∣
    CTI2.ctx-imp (＇ Fin.zero) (＇ target-β) a1-d1-term-var-p ∷ []
...
a2-e4-name-world : CTI2.World 1 2 2
a2-e4-name-world =
  CTI2.world η-src-α-1 η-tgt-βα-2 imp-name-X-2
    e4-source-store target-store-βα

a2-e4-name-WFWorld : CTI2.WFWorld a2-e4-name-world
a2-e4-name-WFWorld Fin.zero eq = target-α , refl

a2-e4-outer-rebase-refuted :
  CTI2.RebaseAtᴿ a2-e4-name-world a2-e4-name-world
    (just target-α)
  → ⊥
a2-e4-outer-rebase-refuted
    (CTI2.rebase-varᴿ {Xᴸ = Fin.zero} rb) =
...
a2-e4-type-leaf-ok :
  e4-source-body CTI2.⊑ᵂ⟨ a2-e4-name-world ⟩ e4-target-name-body
a2-e4-type-leaf-ok = I.⇒⊑⇒ I.X⊑X I.X⊑X

a2-e4-term-var-refuted :
  ＇ Fin.zero CTI2.⊑ᵂ⟨ a2-e4-name-world ⟩ ＇ target-β
  → ⊥
a2-e4-term-var-refuted = no-var1⊑var0

a2-d1-name-world : CTI2.World 2 2 3
a2-d1-name-world =
  CTI2.world η-src-αℓ-2 η-tgt-βα-3 imp-name-X-3
    d1-source-store target-store-βα

a2-d1-name-WFWorld : CTI2.WFWorld a2-d1-name-world
a2-d1-name-WFWorld Fin.zero eq = target-α , refl
a2-d1-name-WFWorld (Fin.suc Fin.zero) ()

a2-d1-outer-rebase-refuted :
  CTI2.RebaseAtᴿ a2-d1-name-world a2-d1-name-world
    (just target-α)
  → ⊥
a2-d1-outer-rebase-refuted
    (CTI2.rebase-varᴿ {Xᴸ = Fin.zero} rb) =
...
a2-d1-type-leaf-ok :
  d1-source-body CTI2.⊑ᵂ⟨ a2-d1-name-world ⟩ d1-target-name-body
a2-d1-type-leaf-ok = I.⇒⊑⇒ I.X⊑X I.★⊑★

a2-d1-term-var-refuted :
  ＇ Fin.zero CTI2.⊑ᵂ⟨ a2-d1-name-world ⟩ ＇ target-β
  → ⊥
...
a3-e4-alias-world : CTI2.World 1 2 2
a3-e4-alias-world =
  CTI2.world η-src-β-1 η-tgt-βα-2 imp-star-2
    e4-source-store target-store-βα

a3-e4-name-world : CTI2.World 1 2 2
a3-e4-name-world =
  CTI2.world η-src-α-1 η-tgt-βα-2 imp-star-2
    e4-source-store target-store-βα

a3-e4-alias-WFWorld : CTI2.WFWorld a3-e4-alias-world
a3-e4-alias-WFWorld Fin.zero ()

a3-e4-name-WFWorld : CTI2.WFWorld a3-e4-name-world
a3-e4-name-WFWorld Fin.zero ()

a3-e4-source-off-name-to-alias : ∀ {Y}
  → Y ≢ Fin.zero
  → toRenameᵗ (CTI2.ηᴸʷ a3-e4-name-world) Y
    ≡ toRenameᵗ (CTI2.ηᴸʷ a3-e4-alias-world) Y
...
a3-e4-outer-rebaseᴿ :
  CTI2.RebaseAtᴿ a3-e4-alias-world a3-e4-name-world
    (just target-α)
a3-e4-outer-rebaseᴿ =
  CTI2.rebase-varᴿ
    (CTI2.rebase-at (CTI2.same-runtime refl refl)
...
a3-e4-inner-rebaseᴿ :
  CTI2.RebaseAtᴿ a3-e4-name-world a3-e4-alias-world
    (just target-β)
a3-e4-inner-rebaseᴿ =
  CTI2.rebase-varᴿ
    (CTI2.rebase-at (CTI2.same-runtime refl refl)
...
a3-e4-type-leaf-ok :
  e4-source-body CTI2.⊑ᵂ⟨ a3-e4-name-world ⟩ e4-target-name-body
a3-e4-type-leaf-ok = I.⇒⊑⇒ I.X⊑X I.X⊑X

a3-e4-term-var-p :
  ＇ Fin.zero CTI2.⊑ᵂ⟨ a3-e4-alias-world ⟩ ＇ target-β
a3-e4-term-var-p = I.X⊑X

a3-e4-term-var-leaf-ok :
  a3-e4-alias-world ∣
    CTI2.ctx-imp (＇ Fin.zero) (＇ target-β) a3-e4-term-var-p ∷ []
    ⊢² ` 0 ⊑ ` 0 ∶ a3-e4-term-var-p
a3-e4-term-var-leaf-ok = var-leaf a3-e4-term-var-p

a3-d1-alias-world : CTI2.World 2 2 3
a3-d1-alias-world =
  CTI2.world η-src-βℓ-2 η-tgt-βα-3 imp-star-3
    d1-source-store target-store-βα

a3-d1-name-world : CTI2.World 2 2 3
a3-d1-name-world =
  CTI2.world η-src-αℓ-2 η-tgt-βα-3 imp-star-3
    d1-source-store target-store-βα
