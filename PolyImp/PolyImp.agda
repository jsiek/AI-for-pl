...
renameᵗ-term {Γ = Γ} ρ (_•_[_] {A = A} {B = B} M α h eq) =
  cast⊢
    refl
    refl
    (trans
...
substᵗ-term {Γ = Γ} σ (_•_[_] {A = A} {B = B} M α h eq) =
  cast⊢
    refl
    refl
    (trans
...
renameˢ-term {Σ = Σ} {Γ = Γ} ρ (_•_[_] {A = A} {B = B} M α h eq) =
  cast⊢
    refl
    refl
    (trans
