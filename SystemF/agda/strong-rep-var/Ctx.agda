module strong-rep-var.Ctx where
...
--     (strong-rep-var.TermSubst) type-preserving.
--
...
-- strong-rep-var.proof.Ctx, for `crossΛᴹ`) or a bind block (`repwk-wkN`,
-- strong-rep-var.proof.RepWeaken, for `Peel`).  `repwk-push` and `repwk-abst`
