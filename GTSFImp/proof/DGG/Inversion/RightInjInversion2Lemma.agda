...
--   * Instantiates the parameterized proof with the composed target walk and
--     the checked source-star-chain inhabitant.
...
right-inj-inversion² =
  Proof.right-inj-inversion² target-tag-seal-walk target-source-star-chain
