module proof.WorldCoherent.Source.OneStep.Cases.NuImprecisionWorldCoherentSourceOneStepDispatcherProof where
...
open import proof.WorldCoherent.Source.RuntimeSteps.NuImprecisionWorldCoherentSourcePureStepDispatcherProof using
