module proof.WorldCoherent.Source.NuCatchup.NuImprecisionWorldCoherentSourceNuBlameStepLemma where
...
open import proof.WorldCoherent.Source.NuCatchup.NuImprecisionWorldCoherentSourceNuBlameStepProof using
