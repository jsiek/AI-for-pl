...
This already exists in `proof.Core.Properties.ImprecisionProperties` as `∀ᵢ-wf²`, but it is
...
1. Add a new module `proof.EndpointMLB.Simple.EndpointCanonicalMLBSimpleSoundness`.
