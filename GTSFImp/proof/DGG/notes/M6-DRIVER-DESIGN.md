...
The plan-indexed Λ top-post obligation is now live; the remaining factory
work is the hereditary prefix worker, Λ-package assembly, and the four
non-Λ descent producers.  M6's fuel knot and factory type require no change.
