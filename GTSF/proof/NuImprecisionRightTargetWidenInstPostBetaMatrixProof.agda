module proof.NuImprecisionRightTargetWidenInstPostBetaMatrixProof where
...
open import proof.NuImprecisionRightTargetWidenInstPostBetaDef using
  (WorldCoherentRightTargetWidenInstPostBetaᵀ)
open import
  proof.NuImprecisionRightTargetWidenInstPostBetaMatrixDef
  using
