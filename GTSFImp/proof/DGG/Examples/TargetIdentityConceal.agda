...
checkpoint₁₁-source-unoccupied : ∀ Xᴿ
  → toRenameⁱ (ηᴿᶜ TIR.checkpoint₃-allocation-world) Xᴿ
    ≢ toRenameⁱ (ηᴸᶜ TIR.checkpoint₃-allocation-world) Fin.zero
...
checkpoint₁-ladder-pinned :
  checkpoint₁-ladder ≡
    ...
    "  │ │ ─                                                  ((Z ⇒ ★) ⇒ (Z ⇒ ★))    ((Z ⇒ ★) ⇒ (Z ⇒ ★))    mark X⊑★ at Z, ★⊑★, mark X⊑★ at Z, ★⊑★ + source rebase  ((★ ⇒ ★) ⇒ (★ ⇒ ★))  ((★ ⇒ ★) ⇒ (★ ⇒ ★))      │ │ □ ↑ ⇒-rev\n" ++
    "  │ │ ─                                                  ((Z ⇒ ★) ⇒ (Z ⇒ ★))    ((Y ⇒ ★) ⇒ (Y ⇒ ★))    Y ≈ Y, ★⊑★, Y ≈ Y, ★⊑★ + source rebase                  ((Y ⇒ ★) ⇒ (Y ⇒ ★))  ((Y′ ⇒ ★) ⇒ (Y′ ⇒ ★))    │ │ □ ↑ ⇒-rev\n" ++
