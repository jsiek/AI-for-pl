module strong-rep-nu.proof.Residual where
...
--     STATEMENT; the theorem is strong-rep-nu.proof.ColorPreservation.
...
open import strong-rep-nu.Types using (Ty; `_; Renameᵗ; renameᵗ; extᵗ; ⇑ᵗ)
...
-- (strong-rep-nu.Residual §3) rebuild exactly the shifted term.
