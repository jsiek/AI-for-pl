...
open import proof.DGGTermImprecision using
  (subst-⊑; wk-left-world-⊑; wk-right-world-⊑)
...
sim-left-app₂ sim-left-step wfΣˡ wfΣʳ vV relL relM redM
  | Ψʳᵥ , Σʳᵥ , wfΣʳᵥ , V′ , vV′ , L′↠V′ , V⊑V′
    with sim-left-step wfΣˡ wfΣʳᵥ
      (wk-left-world-⊑ wfΣˡ wfΣʳᵥ ≤-refl ⊆ˢ-refl relM)
      redM
sim-left-app₂ sim-left-step wfΣˡ wfΣʳ vV relL relM redM
  | Ψʳᵥ , Σʳᵥ , wfΣʳᵥ , V′ , vV′ , L′↠V′ , V⊑V′
  | Ψˡ′ , Ψ≤Ψ′ , wfΣˡ′ , Ψʳ′ , Σʳ′ , wfΣʳ′ , N′ ,
...
private
  ...
  postulate
    sim-left-beta-app-rest :
      ...
      StoreWf 0 Ψʳ Σʳ →
      Value W →
      ⟪ 0 , Ψˡ , Σˡ , Ψʳ , Σʳ , [] ⟫ ⊢ (ƛ C ⇒ N) ⊑ L′ ⦂ (A ⇒ B) ⊑ (A′ ⇒ B′) →
      ⟪ 0 , Ψˡ , Σˡ , Ψʳ , Σʳ , [] ⟫ ⊢ W ⊑ W′ ⦂ A ⊑ A′ →
      ∃[ Ψʳ′ ] ∃[ Σʳ′ ]
        (StoreWf 0 Ψʳ′ Σʳ′ ×
         ∃[ N′ ]
           ((Σʳ ∣ (L′ · W′) —↠ Σʳ′ ∣ N′) ×
            ⟪ 0 , Ψˡ , Σˡ , Ψʳ′ , Σʳ′ , [] ⟫ ⊢ (N [ W ]) ⊑ N′ ⦂ B ⊑ B′))
...
sim-left-beta-app
  ...
  multi-trans (appR-↠ (ƛ A′ ⇒ N′) W′↠V′)
    (((ƛ A′ ⇒ N′) · V′) —→⟨ pure-step (β vV′) ⟩
      (N′ [ V′ ]) ∎) ,
  beta-subst-⊑ {Ψʳ = Ψʳ′} {Σʳ = Σʳ′} pA pA⊢ W⊑V′
    (wk-right-world-⊑ wfΣʳ′ relN)
sim-left-beta-app
  {Ψʳ = Ψʳ} {Σʳ = Σʳ} {W′ = W′}
  wfΣˡ wfΣʳ vW
