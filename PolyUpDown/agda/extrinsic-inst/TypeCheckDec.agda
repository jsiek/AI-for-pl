...
... | yes ((A , M:A) , bfM) with up-cast-check-any Σ (storeWf-unique wfΣ) p
...   | no ¬p =
      no
        (λ
...
...   | yes (Φ′ , (A′ , (B , hp))) with A′ ≟Ty A
...     | yes refl = yes ((B , ⊢up Φ′ M:A hp) , bf-up bfM)
...     | no A′≢A =
        no
          (λ
...
... | yes ((A , M:A) , bfM) with down-cast-check-any Σ (storeWf-unique wfΣ) p
...   | no ¬p =
      no
        (λ
...
...   | yes (Φ′ , (A′ , (B , hp))) with A′ ≟Ty A
...     | yes refl = yes ((B , ⊢down Φ′ M:A hp) , bf-down bfM)
...     | no A′≢A =
        no
          (λ
