module strong-rep-var.notes.CancelRShiftWall where
...
--     `strong-rep-var.proof.MoveScope.preserve-CancelR` proves the
-- preservation
...
--
-- WHAT THE RULE SAID, BEFORE (strong-rep-var.Reduction, until 2026-09-19):
--
...
-- `CancelRCase°` is `strong-rep-var.proof.Preserve.CancelRCase` AS IT STOOD on
