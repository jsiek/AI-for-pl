...
-- stored body.
dynamicGradualGuarantee (Λ⊒Λ allᶜ V⊒V′) (pure-step ())
dynamicGradualGuarantee (⊒Λ pᶜ N⊒V′) (pure-step ())
dynamicGradualGuarantee (⊒⟨ν⟩ pᶜ N⊒V′) (pure-step red) =
  {!!}
dynamicGradualGuarantee (⊒⟨ν⟩ pᶜ N⊒V′) (ξ-⟨⟩ V′→N′) =
  {!!}
dynamicGradualGuarantee (α⊒α qᶜ pαᶜ L⊒L′) (ν-step vV noV)
    with catchup-lemma vV L⊒L′
dynamicGradualGuarantee (α⊒α qᶜ pαᶜ L⊒L′) (ν-step vV noV)
    | χs , N , Δ′ , Π , Π′ , π , p′ , N↠ , Π≡ , Π′≡ , π⊒ , N⊒L′ =
  {!!}
...
dynamicGradualGuarantee (⊕⊒⊕ M⊒M′ N⊒N′) (pure-step δ-⊕)
    | χsM , M , ΔM , ΠM , ΠM′ , πM , pM , M↠ , ΠM≡ , ΠM′≡ , πM⊒ , W⊒M′
    | χsN , N , ΔN , ΠN , ΠN′ , πN , pN , N↠ , ΠN≡ , ΠN′≡ , πN⊒ , W⊒N′ =
  {!!}
