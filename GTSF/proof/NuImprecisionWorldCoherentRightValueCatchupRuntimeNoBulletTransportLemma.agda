module
  proof.NuImprecisionWorldCoherentRightValueCatchupRuntimeNoBulletTransportLemma
  where
...
open import proof.NuImprecisionRightSilentPairedCastTransportProof using
