module proof.NuCore.Relations.NuImprecisionCorrespondingSourceNameNotStarLemma where
...
open import proof.NuCore.Relations.NuImprecisionCorrespondingSourceNameNotStarProof using
