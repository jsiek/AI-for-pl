module proof.DGG.Catchup.LeftSourceCastCatchupDef where

-- File Charter:
--   * States source-headed ordinary-cast catch-up as the separate induction
--     obligation used by left value catch-up.
...
LeftSourceCastCatchupAt : ℕ → Set
LeftSourceCastCatchupAt fuel = ∀ {Δᴸ Δᴿ : TyCtx}
