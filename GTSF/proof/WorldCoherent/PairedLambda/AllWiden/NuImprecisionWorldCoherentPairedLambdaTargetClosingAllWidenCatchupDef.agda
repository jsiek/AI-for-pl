...
-- File Charter:
--   * Defines target-binder closing for the structural universal widening
--     family after one source-only dynamic allocation.
--   * Exposes the complete specialized theorem boundary without choosing a
--     recursive proof or importing another semantic implementation.
...
WorldCoherentPairedLambdaTargetClosingAllWidenCatchupᵀ : Set₁
