...
module proof.Catchup.Core.Catchup where

-- File Charter:
--   * Home for the GTSF catchup lemma used by the dynamic gradual guarantee.
--   * Uses `proof.Catchup.Core.CatchupStore` for the stable store-narrowing append helper
...
open import proof.Core.Properties.ReductionProperties
  using
    ( applyCoercions
...
open import proof.Catchup.Core.CatchupStore
  using
    ( combineStoreNrw
    ; combineStoreNrw-⇑ˢ
