...
-- The proof is complete once the merged-frame name-retention invariant stated
-- as `strong.proof.Progress.MergedReading` is supplied.  That invariant is a
-- new major statement and is deliberately left as a stage-1 parameter for
-- review rather than proved here without approval.
