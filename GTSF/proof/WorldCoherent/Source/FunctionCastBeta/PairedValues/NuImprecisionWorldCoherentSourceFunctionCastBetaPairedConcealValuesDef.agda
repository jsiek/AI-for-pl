...
-- File Charter:
--   * Defines the direct paired-conceal value/value leaf for source
--     function-cast beta.
...
open import NuTermImprecision using
  (StoreCorresponds; StoreImp; leftStoreⁱ; rightStoreⁱ)
...
WorldCoherentSourceFunctionCastBetaPairedConcealValuesᵀ : Set₁
