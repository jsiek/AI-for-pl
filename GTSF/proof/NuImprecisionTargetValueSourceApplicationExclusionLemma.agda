module proof.NuImprecisionTargetValueSourceApplicationExclusionLemma where
...
open import proof.NuImprecisionTargetValueSourceApplicationExclusionDef using
  (QuotientedTargetValueExcludesSourceApplicationᵀ)
open import proof.NuImprecisionTargetValueSourceApplicationExclusionProof using
