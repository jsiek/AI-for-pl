...
New CONTEXT entry form (TyEntry, strong-rep-var/Context.agda):
...
The interior computation  Γ ⇈ Θ  (strong-rep-var/Boundary.agda; used by (env) in the
...
Boundary well-formedness  Γ ∣ Ψ ⊢ Θ  (strong-rep-var/Boundary.agda) — one new
...
The dual construction (entᴳ/cncOfRevs in strong-rep-var/BReduction.agda, feeding the
