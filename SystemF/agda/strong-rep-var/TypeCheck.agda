module strong-rep-var.TypeCheck where
...
--     search that consumes these checkers is strong-rep-var.Eval; the
--     metatheory is under strong-rep-var.proof.  This module depends on none
-- of
...
-- context (the parallel-bind discipline, strong-rep-var.Ctx §9).
...
-- by name from the conversion context (strong-rep-var.Conversion §5).
