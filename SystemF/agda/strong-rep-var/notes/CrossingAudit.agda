module strong-rep-var.notes.CrossingAudit where
...
-- `Peel`.  `strong-rep-var.Examples` §7c is the hardest case the corpus puts
-- to
...
-- strong-rep-var/proof/PeelDual.agda — for an ARBITRARY well-formed change
-- list,
