...
**The appended lock** (§6.4, `strong-rep-store.Boundary` §5):
...
* **The shift audit, and the `TyPeelR` split** (Jeremy, 2026-09-08; this
  ...
  moved boundary's **own** change list (`addLock0`, `strong-rep-store.Boundary`
