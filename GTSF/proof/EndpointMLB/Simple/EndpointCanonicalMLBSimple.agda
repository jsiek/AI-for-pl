module proof.EndpointMLB.Simple.EndpointCanonicalMLBSimple where
...
--     the efficient profile-based algorithm in `proof.EndpointMLB.Core.EndpointCanonicalMLB`.
...
open import proof.Core.Properties.ImprecisionProperties using (nonVar?; imp?)
