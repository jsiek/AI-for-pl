...
module proof.Catchup.Core.NuImprecisionCatchupScratch where
...
open import proof.OneStep.NuImprecisionOneStepSourceCastFrames using
  ( weak-one-step-source-narrow-cast-indexed-frame-outcomeᵀ
  ; weak-one-step-source-widen-cast-indexed-frame-outcomeᵀ
  )
open import proof.OneStep.NuImprecisionOneStepSourceConversionFrames using
...
open import proof.OneStep.NuImprecisionOneStepTargetConversionFrames using
...
open import proof.OneStep.NuImprecisionOneStepTargetConversionRoots using
...
open import proof.OneStep.NuImprecisionOneStepTargetCastRoots using
