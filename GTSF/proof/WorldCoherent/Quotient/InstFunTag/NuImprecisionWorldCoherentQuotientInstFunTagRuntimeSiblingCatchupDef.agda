...
-- File Charter:
--   * Defines exact eager quotient-inst/function-tag catch-up while carrying
--     one independent source-no-bullet, target-runtime sibling.
--   * Keeps the leading instantiation and trailing function tag visible and
--     returns the caught result and sibling at one shared final world.
...
WorldCoherentQuotientInstFunTagRuntimeSiblingCatchupᵀ : Set₁
