module proof.Substitution.Term.NuImprecisionSingleSubstitutionEnvironmentProof where
...
open import proof.Substitution.Term.NuImprecisionLambdaSubstitutionEnvironmentProof using
