module
  proof.NuImprecisionPairedLambdaTargetClosingContinuationValueTerminalPrefixBranchProof
  where
...
open import
  proof.NuImprecisionPairedLambdaTargetClosingContinuationValueTerminalPrefixBranchDef
