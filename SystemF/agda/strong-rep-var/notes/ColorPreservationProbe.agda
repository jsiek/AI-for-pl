module strong-rep-var.notes.ColorPreservationProbe where

-- COLOR PRESERVATION ON ONE RUN (2026-09-21) — the statement layer of
-- strong-rep-var.Residual exercised on a concrete program, before the
-- theorem is proved.  In the renderer's names (`scripts/render_term.sh
-- 'showTmIn 0 Ex' 'open import
-- strong-rep-var.notes.ColorPreservationProbe'`) the program and its
-- three states are
--
...
open import strong-rep-var.Types hiding (idᵗ)
