module strong-rep-var.proof.AddLock0 where
...
--                  `strong-rep-var.proof.PeelDual.respell-⊢` to move it onto
-- the
...
open import strong-rep-var.proof.RepWeaken using (⊢renᴿ)
open import strong-rep-var.proof.PeelDual using (respell-⊢)
