module proof.NuImprecisionParallelTermSubstitutionUniversalProof where
...
open import
  proof.NuImprecisionParallelTermSubstitutionUniversalDef using
...
open import proof.NuTermProperties using (substˣᵐ-preserves-Value)
