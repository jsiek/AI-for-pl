...
| M4 | `ExtraCastRight²` consuming cases, HIGHER-ORDER over RightInjInversion² + InstCatchupRight² Defs (Catchup/ExtraCastRight*; per-family workers; stitch pending walk closure) | M | **in progress** | — |
