module strong-rep-var.Eval where
...
--     `progress`, and it lives in strong-rep-var.Progress /
-- strong-rep-var.proof.
--     The rules are strong-rep-var.Reduction; the checkers every premise here
--     comes from are strong-rep-var.TypeCheck; the recorded runs are
...
--
-- On a well-typed term, determinism (`det`, strong-rep-var.Reduction) is what
-- makes
...
-- Those are decided by strong-rep-var.TypeCheck, which returns the ordinary
