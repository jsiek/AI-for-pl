...
Store : TyCtx → SealCtx → Set
Store Δ Ψ = List (Seal Ψ × Ty Δ Ψ)

∅ˢ : ∀{Δ Ψ} → Store Δ Ψ
∅ˢ = []

extendˢ : ∀{Δ}{Ψ} → Store Δ Ψ → Seal Ψ → Ty Δ Ψ → Store Δ Ψ
extendˢ Σ α A = (α , A) ∷ Σ
...
renameStoreᵗ : ∀{Δ}{Δ′}{Ψ} → Renameᵗ Δ Δ′ → Store Δ Ψ → Store Δ′ Ψ
renameStoreᵗ ρ [] = []
renameStoreᵗ ρ ((α , A) ∷ Σ) =
  (α , renameᵗ ρ A) ∷ renameStoreᵗ ρ Σ

⟰ᵗ : ∀{Δ}{Ψ} → Store Δ Ψ → Store (suc Δ) Ψ
⟰ᵗ = renameStoreᵗ Sᵗ
...
renameStoreˢ : ∀{Δ}{Ψ}{Ψ′} → Renameˢ Ψ Ψ′ → Store Δ Ψ → Store Δ Ψ′
renameStoreˢ ρ [] = []
renameStoreˢ ρ ((α , A) ∷ Σ) =
  (ρ α , renameˢ ρ A) ∷ renameStoreˢ ρ Σ

⟰ˢ : ∀{Δ}{Ψ} → Store Δ Ψ → Store Δ (suc Ψ)
⟰ˢ = renameStoreˢ Sˢ
...
data _∋ˢ_⦂_ : ∀{Δ}{Ψ} → Store Δ Ψ → Seal Ψ → Ty Δ Ψ → Set where
  Z∋ˢ : ∀{Δ}{Ψ}{Σ : Store Δ Ψ}{A B : Ty Δ Ψ}{α β : Seal Ψ}
       → α ≡ β
       → A ≡ B
       → ((β , B) ∷ Σ) ∋ˢ α ⦂ A
       
  S∋ˢ : ∀{Δ}{Ψ}{Σ : Store Δ Ψ}{α β : Seal Ψ}{A B : Ty Δ Ψ}
       → Σ ∋ˢ α ⦂ A
       → ((β , B) ∷ Σ) ∋ˢ α ⦂ A
