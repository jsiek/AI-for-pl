module strong-rep-nu.notes.ReUnlockWall where
...
--     `conv-bind-live` in strong-rep-nu.Boundary §3.
--
-- HOW THIS WAS FOUND.  By finishing the tower example
-- (strong-rep-nu.Examples §5a).  The eleventh step of that
...
open import strong-rep-nu.Types using (Ty; `_; `ℕ; `𝔹)
open import strong-rep-nu.Ctx
open import strong-rep-nu.Boundary
open import strong-rep-nu.TypeCheck using (conv!)
