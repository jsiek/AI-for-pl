module strong.notes.RepWeakenBindsWall where
...
-- closed, one-boundary program `β-seven` (strong.Terms §5) at the EMPTY
...
-- one call site — `Peel`'s crossing argument, strong.proof.PeelDual §3 —
...
-- `strong.proof.RepWeaken.rep-weaken-⊢`.

open import Data.List using (List; []; _∷_; length)
open import Relation.Nullary using (¬_)
open import Relation.Binary.PropositionalEquality using (_≡_; refl)

open import strong.Types using (Ty; `_; `ℕ)
open import strong.Ctx
open import strong.Conversion
open import strong.CtxMorph
open import strong.Terms
open import strong.TermSubst using (renᴹᴿ; wkN)
