module LR-narrow.Examples.Cambridge26.K.Example17 where

-- File Charter:
--   * Applies fully dynamic K obtained in Y-then-X order.
...
example =
  ...
  (instantiate-X-after-Y (instantiate-Y k) · nat★ 42 · nat★ 69)
  is-just is-just
