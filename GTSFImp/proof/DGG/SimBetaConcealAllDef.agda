module proof.DGG.SimBetaConcealAllDef where

-- File Charter:
--   * States simulation of source universal-conceal beta reduction.
--   * Packages target catch-up, reduction, parked-world evolution, and the
--     final instantiated concealed-value relation behind one interface.
--   * Contains no universal-conceal-beta simulation proof.
