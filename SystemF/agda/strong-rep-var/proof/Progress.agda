module strong-rep-var.proof.Progress where

-- PROGRESS for the two-universe conversion-boundary calculus.
--
-- The ordinary cases are the standard induction, using
-- strong-rep-var.proof.Canonical.  Boundary reductions additionally construct
-- the
...
--
-- `` ⊆ᵃ states only name availability.  strong-rep-var.Conversion.respell-ty
-- then
