...
-- File Charter:
--   * States source reveal and conceal catch-up beneath the canonical full
--     CTI zipper as separate semantic inductions.
--   * Keeps each exact conversion checkpoint and whole related root visible
...
ContextualLeftSourceConcealCatchupAt : ℕ → Set₁
