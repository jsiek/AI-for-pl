module proof.Substitution.Term.NuImprecisionLambdaSubstitutionEnvironmentProof where
...
open import
  proof.Substitution.Term.NuImprecisionLambdaSubstitutionEnvironmentDef
