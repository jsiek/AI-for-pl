module strong-rep-var.Progress where
...
-- Preservation
--     is strong-rep-var.Preservation; the composition of the two is
...
open import strong-rep-var.Ctx using (Ctxᵗ)
open import strong-rep-var.Terms using (Term; Value; _∣_⊢_⦂_)
open import strong-rep-var.Reduction using (_⊢_-→_)
import strong-rep-var.proof.Progress as P
