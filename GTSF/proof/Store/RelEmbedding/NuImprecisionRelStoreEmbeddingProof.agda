...
private
  ...
  rel-store-embedding-matched∈ⁱ
      (rel-store-embedding-matched
        {p′ = p′} eqα eqA eqβ eqB shape-eq emb) (here refl) =
    _ , _ , _ , _ , p′ ,
    eqα , eqA , eqβ , eqB , shape-eq , here refl
  rel-store-embedding-matched∈ⁱ
      (rel-store-embedding-matched
        eqα eqA eqβ eqB shape-eq emb) (there p∈) =
    let α′ , A′ , β′ , B′ , p′ ,
          eqα′ , eqA′ , eqβ′ , eqB′ , shape-eq′ , p∈′ =
          rel-store-embedding-matched∈ⁱ emb p∈ in
    α′ , A′ , β′ , B′ , p′ ,
    eqα′ , eqA′ , eqβ′ , eqB′ , shape-eq′ , there p∈′
  rel-store-embedding-matched∈ⁱ
  ...
  rel-store-embedding-matched∈ⁱ
      (rel-store-embedding-link
        eqα eqA eqβ eqB shape-eq emb) (here ())
  rel-store-embedding-matched∈ⁱ
      (rel-store-embedding-link
        eqα eqA eqβ eqB shape-eq emb) (there p∈) =
    let α′ , A′ , β′ , B′ , p′ ,
