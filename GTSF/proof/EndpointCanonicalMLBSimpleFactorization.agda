...
record SpanTransport (ρ : Renameᵗ) (source target : SpanCtx) : Set where
  constructor span-transport
  field
    left-span-transport :
      CommonTransport ρ (left-context source) (left-context target)
    right-span-transport :
      CommonTransport ρ (right-context source) (right-context target)
...
transport-νν-swap :
  ...
  CommonTransport ForallPermutation.swap01ᵗ
    (νᵢᶜ (νᵢᶜ Φ)) (νᵢᶜ (νᵢᶜ Φ))
transport-νν-swap Φ .transport-var (here ())
transport-νν-swap Φ .transport-var {X = zero} (there x∈) =
  ⊥-elim (no-⇑ᴸᵢ-zero-left x∈)
transport-νν-swap Φ .transport-var
    {X = suc zero} (there x∈) =
  ⊥-elim (no-νctx-zero-var (un⇑ᴸᵢ-ˣ∈ x∈))
transport-νν-swap Φ .transport-var
    {X = suc (suc X)} (there x∈) =
  there
    (⇑ᴸᵢ-∈
      (there
        (⇑ᴸᵢ-∈ (unν-var (un⇑ᴸᵢ-ˣ∈ x∈)))))
transport-νν-swap Φ .transport-star (here refl) =
  there (⇑ᴸᵢ-∈ (here refl))
transport-νν-swap Φ .transport-star {X = zero} (there x∈) =
  ⊥-elim (no-⇑ᴸᵢ-zero-star x∈)
transport-νν-swap Φ .transport-star
    {X = suc zero} (there x∈) =
  here refl
transport-νν-swap Φ .transport-star
    {X = suc (suc X)} (there x∈) =
...
span-transport-both :
  ∀ {ρ source target} →
  SpanTransport ρ source target →
  SpanTransport (extᵗ ρ)
    (extend-span bothˢ source) (extend-span bothˢ target)
span-transport-both transport =
  span-transport
    (transport-∀ (left-span-transport transport))
    (transport-∀ (right-span-transport transport))

span-transport-left :
  ∀ {ρ source target} →
  SpanTransport ρ source target →
  SpanTransport (extᵗ ρ)
    (extend-span leftˢ source) (extend-span leftˢ target)
span-transport-left transport =
  span-transport
    (transport-∀ (left-span-transport transport))
    (transport-ν (right-span-transport transport))

span-transport-right :
  ∀ {ρ source target} →
  SpanTransport ρ source target →
  SpanTransport (extᵗ ρ)
    (extend-span rightˢ source) (extend-span rightˢ target)
span-transport-right transport =
  span-transport
    (transport-ν (left-span-transport transport))
    (transport-∀ (right-span-transport transport))

span-transport-neither :
  ∀ {ρ source target} →
  SpanTransport ρ source target →
  SpanTransport (extᵗ ρ)
    (extend-span neitherˢ source) (extend-span neitherˢ target)
span-transport-neither transport =
  span-transport
    (transport-ν (left-span-transport transport))
    (transport-ν (right-span-transport transport))

paired-lower-rename-common :
  ∀ {ρ source target Δˢ Δᵗ Δᴸ Δᴿ C A B} →
  SpanTransport ρ source target →
  (∀ {X} → X < Δˢ → ρ X < Δᵗ) →
  PairedLower source Δˢ C A B Δᴸ Δᴿ →
  PairedLower target Δᵗ (renameᵗ ρ C) A B Δᴸ Δᴿ
paired-lower-rename-common transport ρ-wf paired-star = paired-star
paired-lower-rename-common transport ρ-wf paired-base-base =
  paired-base-base
paired-lower-rename-common transport ρ-wf paired-base-star =
  paired-base-star
paired-lower-rename-common transport ρ-wf paired-star-base =
  paired-star-base
paired-lower-rename-common transport ρ-wf paired-base-stars =
  paired-base-stars
paired-lower-rename-common transport ρ-wf
    (paired-arrow-arrow lower₁ lower₂) =
  paired-arrow-arrow
    (paired-lower-rename-common transport ρ-wf lower₁)
    (paired-lower-rename-common transport ρ-wf lower₂)
paired-lower-rename-common transport ρ-wf
...
paired-lower-rename-common transport ρ-wf
  ...
  paired-arrow-stars
    ...
    (paired-lower-rename-common transport ρ-wf lower₂)
paired-lower-rename-common transport ρ-wf
    (paired-var-var row Z<Δ X<Δ Y<Δ) =
  paired-var-var
    (row-var-var
      (transport-var (left-span-transport transport)
        (proof.EndpointCanonicalMLBSimplePairedSpan.row-var-var-left row))
      (transport-var (right-span-transport transport)
        (proof.EndpointCanonicalMLBSimplePairedSpan.row-var-var-right row)))
    (ρ-wf Z<Δ) X<Δ Y<Δ
paired-lower-rename-common transport ρ-wf
    (paired-var-star row Z<Δ X<Δ) =
  paired-var-star
    (row-var-star
      (transport-var (left-span-transport transport)
        (proof.EndpointCanonicalMLBSimplePairedSpan.row-var-star-left row))
      (transport-star (right-span-transport transport)
        (proof.EndpointCanonicalMLBSimplePairedSpan.row-var-star-right row)))
    (ρ-wf Z<Δ) X<Δ
paired-lower-rename-common transport ρ-wf
    (paired-star-var row Z<Δ Y<Δ) =
  paired-star-var
    (row-star-var
      (transport-star (left-span-transport transport)
        (proof.EndpointCanonicalMLBSimplePairedSpan.row-star-var-left row))
      (transport-var (right-span-transport transport)
        (proof.EndpointCanonicalMLBSimplePairedSpan.row-star-var-right row)))
    (ρ-wf Z<Δ) Y<Δ
paired-lower-rename-common transport ρ-wf
  ...
  paired-var-stars
    (row-star-star
      (transport-star (left-span-transport transport)
        (proof.EndpointCanonicalMLBSimplePairedSpan.row-star-star-left row))
      (transport-star (right-span-transport transport)
        (proof.EndpointCanonicalMLBSimplePairedSpan.row-star-star-right row)))
    (ρ-wf Z<Δ)
paired-lower-rename-common transport ρ-wf (paired-both lower) =
  paired-both
    (paired-lower-rename-common
      (span-transport-both transport) (TyRenameWf-ext ρ-wf) lower)
paired-lower-rename-common transport ρ-wf
    (paired-left {C = C} occ lower) =
  paired-left (trans (occurs-zero-rename-ext _ C) occ)
    (paired-lower-rename-common
      (span-transport-left transport) (TyRenameWf-ext ρ-wf) lower)
paired-lower-rename-common transport ρ-wf
    (paired-right {C = C} occ lower) =
  paired-right (trans (occurs-zero-rename-ext _ C) occ)
    (paired-lower-rename-common
      (span-transport-right transport) (TyRenameWf-ext ρ-wf) lower)
paired-lower-rename-common transport ρ-wf
    (paired-neither {C = C} occ lower) =
  paired-neither (trans (occurs-zero-rename-ext _ C) occ)
    (paired-lower-rename-common
      (span-transport-neither transport) (TyRenameWf-ext ρ-wf) lower)

paired-lower-swap-left-right :
  ∀ {source Δᶜ Δᴸ Δᴿ C A B} →
  occurs zero (`∀ C) ≡ true →
  occurs zero C ≡ true →
  PairedLower
    (extend-span rightˢ (extend-span leftˢ source))
    (suc (suc Δᶜ)) C A B (suc Δᴸ) (suc Δᴿ) →
  PairedLower source Δᶜ
    (`∀ (`∀ (renameᵗ ForallPermutation.swap01ᵗ C)))
    (`∀ A) (`∀ B) Δᴸ Δᴿ
paired-lower-swap-left-right {source = source} {C = C}
    outer-occ inner-occ lower =
  paired-right (occurs-swap01-right {A = C} inner-occ)
    (paired-left (occurs-swap01-left {A = C} outer-occ)
      (paired-lower-rename-common
        (span-transport
          (transport-ν∀-to-∀ν (left-context source))
          (transport-∀ν-to-ν∀ (right-context source)))
        swap01-pres-< lower))

paired-lower-swap-right-left :
  ∀ {source Δᶜ Δᴸ Δᴿ C A B} →
  occurs zero (`∀ C) ≡ true →
  occurs zero C ≡ true →
  PairedLower
    (extend-span leftˢ (extend-span rightˢ source))
    (suc (suc Δᶜ)) C A B (suc Δᴸ) (suc Δᴿ) →
  PairedLower source Δᶜ
    (`∀ (`∀ (renameᵗ ForallPermutation.swap01ᵗ C)))
    (`∀ A) (`∀ B) Δᴸ Δᴿ
paired-lower-swap-right-left {source = source} {C = C}
    outer-occ inner-occ lower =
  paired-left (occurs-swap01-right {A = C} inner-occ)
    (paired-right (occurs-swap01-left {A = C} outer-occ)
      (paired-lower-rename-common
        (span-transport
          (transport-∀ν-to-ν∀ (left-context source))
          (transport-ν∀-to-∀ν (right-context source)))
...
paired-lower-swap-neither-left :
  ∀ {source Δᶜ Δᴸ Δᴿ C A B} →
  occurs zero (`∀ C) ≡ true →
  occurs zero C ≡ true →
  PairedLower
    (extend-span leftˢ (extend-span neitherˢ source))
    (suc (suc Δᶜ)) C A B (suc Δᴸ) Δᴿ →
  PairedLower source Δᶜ
    (`∀ (`∀ (renameᵗ ForallPermutation.swap01ᵗ C)))
    (`∀ A) B Δᴸ Δᴿ
paired-lower-swap-neither-left {source = source} {C = C}
    outer-occ inner-occ lower =
  paired-left (occurs-swap01-right {A = C} inner-occ)
    (paired-neither (occurs-swap01-left {A = C} outer-occ)
      (paired-lower-rename-common
        (span-transport
          (transport-∀ν-to-ν∀ (left-context source))
          (transport-νν-swap (right-context source)))
        swap01-pres-< lower))

paired-lower-swap-neither-right :
  ∀ {source Δᶜ Δᴸ Δᴿ C A B} →
  occurs zero (`∀ C) ≡ true →
  occurs zero C ≡ true →
  PairedLower
    (extend-span rightˢ (extend-span neitherˢ source))
    (suc (suc Δᶜ)) C A B Δᴸ (suc Δᴿ) →
  PairedLower source Δᶜ
    (`∀ (`∀ (renameᵗ ForallPermutation.swap01ᵗ C)))
    A (`∀ B) Δᴸ Δᴿ
paired-lower-swap-neither-right {source = source} {C = C}
    outer-occ inner-occ lower =
  paired-right (occurs-swap01-right {A = C} inner-occ)
    (paired-neither (occurs-swap01-left {A = C} outer-occ)
      (paired-lower-rename-common
        (span-transport
          (transport-νν-swap (left-context source))
          (transport-∀ν-to-ν∀ (right-context source)))
        swap01-pres-< lower))

data ForallPrefix : Ty → Ty → Set where
  prefix-here : ∀ {A} → ForallPrefix A A
  prefix-∀ : ∀ {A B} → ForallPrefix A B → ForallPrefix (`∀ A) B

consume-prefix :
  ∀ {O A} →
  ForallPrefix O (`∀ A) →
  ForallPrefix O A
consume-prefix prefix-here = prefix-∀ prefix-here
consume-prefix (prefix-∀ prefix) = prefix-∀ (consume-prefix prefix)

prefix-count : ∀ {O A} → ForallPrefix O A → ℕ
prefix-count prefix-here = zero
prefix-count (prefix-∀ prefix) = suc (prefix-count prefix)

consume-prefix-count :
  ∀ {O A} (prefix : ForallPrefix O (`∀ A)) →
  prefix-count (consume-prefix prefix) ≡ suc (prefix-count prefix)
consume-prefix-count prefix-here = refl
consume-prefix-count (prefix-∀ prefix) =
  cong suc (consume-prefix-count prefix)

record EndpointAlignment (Aˢ Aᵗ : Ty) : Set where
  constructor aligned-by
  field
    original : Ty
    source-prefix : ForallPrefix original Aˢ
    target-prefix : ForallPrefix original Aᵗ

open EndpointAlignment

alignment-refl : ∀ {A} → EndpointAlignment A A
alignment-refl = aligned-by _ prefix-here prefix-here

consume-source :
  ∀ {Aˢ Aᵗ} →
  EndpointAlignment (`∀ Aˢ) Aᵗ →
  EndpointAlignment Aˢ Aᵗ
consume-source (aligned-by O source target) =
  aligned-by O (consume-prefix source) target

consume-target :
  ∀ {Aˢ Aᵗ} →
  EndpointAlignment Aˢ (`∀ Aᵗ) →
  EndpointAlignment Aˢ Aᵗ
consume-target (aligned-by O source target) =
  aligned-by O source (consume-prefix target)
...
world-exposure-count : SpanWorld → ℕ
world-exposure-count (world-root root) = zero
world-exposure-count (world-extend mode world) =
  suc (world-exposure-count world)

world-left-count : SpanWorld → ℕ
world-left-count (world-root root) = zero
world-left-count (world-extend bothˢ world) =
  suc (world-left-count world)
world-left-count (world-extend leftˢ world) =
  suc (world-left-count world)
world-left-count (world-extend rightˢ world) =
  world-left-count world
world-left-count (world-extend neitherˢ world) =
  world-left-count world

world-right-count : SpanWorld → ℕ
world-right-count (world-root root) = zero
world-right-count (world-extend bothˢ world) =
  suc (world-right-count world)
world-right-count (world-extend leftˢ world) =
  world-right-count world
world-right-count (world-extend rightˢ world) =
  suc (world-right-count world)
world-right-count (world-extend neitherˢ world) =
  world-right-count world

record ScheduleSignature : Set where
  constructor schedule-signature
  field
    binder-count : ℕ
    left-binder-count : ℕ
    right-binder-count : ℕ

world-signature : SpanWorld → ScheduleSignature
world-signature world =
  schedule-signature
    (world-exposure-count world)
    (world-left-count world)
    (world-right-count world)
...
lift-row-both :
  ∀ {Σ Z L R} →
  Z ↦⟨ L , R ⟩∈ Σ →
  suc Z ↦⟨ shift-left-view bothˢ L ,
    shift-right-view bothˢ R ⟩∈ extend-span bothˢ Σ
lift-row-both (row-var-var Z⊑X Z⊑Y) =
  row-var-var (there (⇑ᵢ-ˣ∈ Z⊑X)) (there (⇑ᵢ-ˣ∈ Z⊑Y))
lift-row-both (row-var-star Z⊑X Z⊑★) =
  row-var-star (there (⇑ᵢ-ˣ∈ Z⊑X)) (there (⇑ᵢ-★∈ Z⊑★))
lift-row-both (row-star-var Z⊑★ Z⊑Y) =
  row-star-var (there (⇑ᵢ-★∈ Z⊑★)) (there (⇑ᵢ-ˣ∈ Z⊑Y))
lift-row-both (row-star-star Z⊑★ Z⊑★′) =
  row-star-star
    (there (⇑ᵢ-★∈ Z⊑★)) (there (⇑ᵢ-★∈ Z⊑★′))
...
lift-row-left :
  ∀ {Σ Z L R} →
  Z ↦⟨ L , R ⟩∈ Σ →
  suc Z ↦⟨ shift-left-view leftˢ L ,
    shift-right-view leftˢ R ⟩∈ extend-span leftˢ Σ
lift-row-left (row-var-var Z⊑X Z⊑Y) =
  row-var-var (there (⇑ᵢ-ˣ∈ Z⊑X)) (there (⇑ᴸᵢ-∈ Z⊑Y))
lift-row-left (row-var-star Z⊑X Z⊑★) =
  row-var-star (there (⇑ᵢ-ˣ∈ Z⊑X)) (there (⇑ᴸᵢ-∈ Z⊑★))
lift-row-left (row-star-var Z⊑★ Z⊑Y) =
  row-star-var (there (⇑ᵢ-★∈ Z⊑★)) (there (⇑ᴸᵢ-∈ Z⊑Y))
lift-row-left (row-star-star Z⊑★ Z⊑★′) =
  row-star-star
    (there (⇑ᵢ-★∈ Z⊑★)) (there (⇑ᴸᵢ-∈ Z⊑★′))

lift-row-right :
  ∀ {Σ Z L R} →
  Z ↦⟨ L , R ⟩∈ Σ →
  suc Z ↦⟨ shift-left-view rightˢ L ,
    shift-right-view rightˢ R ⟩∈ extend-span rightˢ Σ
lift-row-right (row-var-var Z⊑X Z⊑Y) =
  row-var-var (there (⇑ᴸᵢ-∈ Z⊑X)) (there (⇑ᵢ-ˣ∈ Z⊑Y))
lift-row-right (row-var-star Z⊑X Z⊑★) =
  row-var-star (there (⇑ᴸᵢ-∈ Z⊑X)) (there (⇑ᵢ-★∈ Z⊑★))
lift-row-right (row-star-var Z⊑★ Z⊑Y) =
  row-star-var (there (⇑ᴸᵢ-∈ Z⊑★)) (there (⇑ᵢ-ˣ∈ Z⊑Y))
lift-row-right (row-star-star Z⊑★ Z⊑★′) =
  row-star-star
    (there (⇑ᴸᵢ-∈ Z⊑★)) (there (⇑ᵢ-★∈ Z⊑★′))

lift-row-neither :
  ∀ {Σ Z L R} →
  Z ↦⟨ L , R ⟩∈ Σ →
  suc Z ↦⟨ shift-left-view neitherˢ L ,
    shift-right-view neitherˢ R ⟩∈ extend-span neitherˢ Σ
lift-row-neither (row-var-var Z⊑X Z⊑Y) =
  row-var-var (there (⇑ᴸᵢ-∈ Z⊑X)) (there (⇑ᴸᵢ-∈ Z⊑Y))
lift-row-neither (row-var-star Z⊑X Z⊑★) =
  row-var-star (there (⇑ᴸᵢ-∈ Z⊑X)) (there (⇑ᴸᵢ-∈ Z⊑★))
lift-row-neither (row-star-var Z⊑★ Z⊑Y) =
  row-star-var (there (⇑ᴸᵢ-∈ Z⊑★)) (there (⇑ᴸᵢ-∈ Z⊑Y))
lift-row-neither (row-star-star Z⊑★ Z⊑★′) =
  row-star-star
    (there (⇑ᴸᵢ-∈ Z⊑★)) (there (⇑ᴸᵢ-∈ Z⊑★′))

world-row-sound :
  ∀ {world Z L R} →
  WorldRow world Z L R →
  Z ↦⟨ L , R ⟩∈ world-context world
world-row-sound (world-root-row row) = row
world-row-sound world-head-both =
  row-var-var (here refl) (here refl)
world-row-sound world-head-left =
  row-var-star (here refl) (here refl)
world-row-sound world-head-right =
  row-star-var (here refl) (here refl)
world-row-sound world-head-neither =
  row-star-star (here refl) (here refl)
world-row-sound
    (world-tail {mode = bothˢ} row refl refl) =
  lift-row-both (world-row-sound row)
world-row-sound
    (world-tail {mode = leftˢ} row refl refl) =
  lift-row-left (world-row-sound row)
world-row-sound
    (world-tail {mode = rightˢ} row refl refl) =
  lift-row-right (world-row-sound row)
world-row-sound
    (world-tail {mode = neitherˢ} row refl refl) =
  lift-row-neither (world-row-sound row)
...
observed-pullback :
  ∀ {source-world target-world Z W L R} →
  Z ↦⟨ L , R ⟩∈ world-context source-world →
  W ↦⟨ L , R ⟩∈ world-context target-world →
  PullsBack source-world target-world Z W
observed-pullback source-row target-row =
  pull-row
    (generated-row-complete source-row)
    (generated-row-complete target-row)
...
paired-variable-pullback :
  ∀ { source-world target-world Δˢ Δᵗ Δᴸ Δᴿ Z W A B } →
  PairedLower
    (world-context source-world) Δˢ
    (＇ Z) A B Δᴸ Δᴿ →
  PairedLower
    (world-context target-world) Δᵗ
    (＇ W) A B Δᴸ Δᴿ →
  PullsBack source-world target-world Z W
paired-variable-pullback
    (paired-var-var source-row Z<Δˢ X<Δᴸ Y<Δᴿ)
    (paired-var-var target-row W<Δᵗ X<Δᴸ′ Y<Δᴿ′) =
  observed-pullback source-row target-row
paired-variable-pullback
    (paired-var-star source-row Z<Δˢ X<Δᴸ)
    (paired-var-star target-row W<Δᵗ X<Δᴸ′) =
  observed-pullback source-row target-row
paired-variable-pullback
    (paired-star-var source-row Z<Δˢ Y<Δᴿ)
    (paired-star-var target-row W<Δᵗ Y<Δᴿ′) =
  observed-pullback source-row target-row
paired-variable-pullback
    (paired-var-stars source-row Z<Δˢ)
    (paired-var-stars target-row W<Δᵗ) =
  observed-pullback source-row target-row

crossed-left-pullback :
  ∀ {source target} →
  PullsBack
    (world-extend rightˢ
      (world-extend leftˢ (world-root source)))
    (world-extend leftˢ
      (world-extend rightˢ (world-root target)))
    (suc zero) zero
crossed-left-pullback =
  pull-row
    (world-tail world-head-left refl refl)
    world-head-left

crossed-right-pullback :
  ∀ {source target} →
  PullsBack
    (world-extend rightˢ
      (world-extend leftˢ (world-root source)))
...
crossed-right-pullback =
  pull-row
    world-head-right
    (world-tail world-head-right refl refl)

data EndpointStep :
    SpanExposure → Ty → Ty → Ty → Ty → Set where
  step-both :
    ∀ {A B} →
    EndpointStep bothˢ (`∀ A) (`∀ B) A B

  step-left :
    ∀ {A B} →
    EndpointStep leftˢ (`∀ A) B A B

  step-right :
    ∀ {A B} →
    EndpointStep rightˢ A (`∀ B) A B

  step-neither :
    ∀ {A B} →
    EndpointStep neitherˢ A B A B

record PendingSpan
    (source-world target-world : SpanWorld)
    (Aˢ Aᵗ Bˢ Bᵗ : Ty) : Set where
  constructor pending-span
  field
    left-alignment : EndpointAlignment Aˢ Aᵗ
    right-alignment : EndpointAlignment Bˢ Bᵗ

open PendingSpan

record PendingAccounting
    {source target Aˢ Aᵗ Bˢ Bᵗ}
    (pending : PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ) : Set where
  constructor accounts
  field
    accounts-source-left :
      prefix-count (source-prefix (left-alignment pending)) ≡
      world-left-count source
    accounts-target-left :
      prefix-count (target-prefix (left-alignment pending)) ≡
      world-left-count target
    accounts-source-right :
      prefix-count (source-prefix (right-alignment pending)) ≡
      world-right-count source
    accounts-target-right :
      prefix-count (target-prefix (right-alignment pending)) ≡
      world-right-count target

open PendingAccounting

initial-pending-span :
  ∀ {source target A B} →
  PendingSpan (world-root source) (world-root target) A A B B
initial-pending-span = pending-span alignment-refl alignment-refl

initial-accounting :
  ∀ {source target A B} →
  PendingAccounting
    (initial-pending-span {source = source} {target = target} {A = A} {B = B})
initial-accounting = accounts refl refl refl refl

advance-source :
  ∀ {source target mode Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Bˢ′} →
  EndpointStep mode Aˢ Bˢ Aˢ′ Bˢ′ →
  PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ →
  PendingSpan (world-extend mode source) target Aˢ′ Aᵗ Bˢ′ Bᵗ
advance-source step-both (pending-span left right) =
  pending-span (consume-source left) (consume-source right)
advance-source step-left (pending-span left right) =
  pending-span (consume-source left) right
advance-source step-right (pending-span left right) =
  pending-span left (consume-source right)
advance-source step-neither (pending-span left right) =
  pending-span left right

advance-source-accounting :
  ∀ {source target mode Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Bˢ′}
    (step : EndpointStep mode Aˢ Bˢ Aˢ′ Bˢ′)
    (pending : PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ) →
  PendingAccounting pending →
  PendingAccounting (advance-source step pending)
advance-source-accounting step-both (pending-span left right) accounting =
  accounts
    (trans (consume-prefix-count (source-prefix left))
      (cong suc (accounts-source-left accounting)))
    (accounts-target-left accounting)
    (trans (consume-prefix-count (source-prefix right))
      (cong suc (accounts-source-right accounting)))
    (accounts-target-right accounting)
advance-source-accounting step-left (pending-span left right) accounting =
  accounts
    (trans (consume-prefix-count (source-prefix left))
      (cong suc (accounts-source-left accounting)))
    (accounts-target-left accounting)
    (accounts-source-right accounting)
    (accounts-target-right accounting)
advance-source-accounting step-right (pending-span left right) accounting =
  accounts
    (accounts-source-left accounting)
    (accounts-target-left accounting)
    (trans (consume-prefix-count (source-prefix right))
      (cong suc (accounts-source-right accounting)))
    (accounts-target-right accounting)
advance-source-accounting step-neither
    (pending-span left right) accounting =
  accounts
    (accounts-source-left accounting)
    (accounts-target-left accounting)
    (accounts-source-right accounting)
...
advance-target :
  ∀ {source target mode Aˢ Aᵗ Bˢ Bᵗ Aᵗ′ Bᵗ′} →
  EndpointStep mode Aᵗ Bᵗ Aᵗ′ Bᵗ′ →
  PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ →
  PendingSpan source (world-extend mode target) Aˢ Aᵗ′ Bˢ Bᵗ′
advance-target step-both (pending-span left right) =
  pending-span (consume-target left) (consume-target right)
advance-target step-left (pending-span left right) =
  pending-span (consume-target left) right
advance-target step-right (pending-span left right) =
  pending-span left (consume-target right)
advance-target step-neither (pending-span left right) =
  pending-span left right

advance-target-accounting :
  ∀ {source target mode Aˢ Aᵗ Bˢ Bᵗ Aᵗ′ Bᵗ′}
    (step : EndpointStep mode Aᵗ Bᵗ Aᵗ′ Bᵗ′)
    (pending : PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ) →
  PendingAccounting pending →
  PendingAccounting (advance-target step pending)
advance-target-accounting step-both (pending-span left right) accounting =
  accounts
    (accounts-source-left accounting)
    (trans (consume-prefix-count (target-prefix left))
      (cong suc (accounts-target-left accounting)))
    (accounts-source-right accounting)
    (trans (consume-prefix-count (target-prefix right))
      (cong suc (accounts-target-right accounting)))
advance-target-accounting step-left (pending-span left right) accounting =
  accounts
    (accounts-source-left accounting)
    (trans (consume-prefix-count (target-prefix left))
      (cong suc (accounts-target-left accounting)))
    (accounts-source-right accounting)
    (accounts-target-right accounting)
advance-target-accounting step-right (pending-span left right) accounting =
  accounts
    (accounts-source-left accounting)
    (accounts-target-left accounting)
    (accounts-source-right accounting)
    (trans (consume-prefix-count (target-prefix right))
      (cong suc (accounts-target-right accounting)))
advance-target-accounting step-neither
    (pending-span left right) accounting =
  accounts
    (accounts-source-left accounting)
    (accounts-target-left accounting)
...
advance-pending-span :
  ∀ { source target source-mode target-mode
      Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Aᵗ′ Bˢ′ Bᵗ′ } →
  EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
  EndpointStep target-mode Aᵗ Bᵗ Aᵗ′ Bᵗ′ →
  PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ →
  PendingSpan
    (world-extend source-mode source)
    (world-extend target-mode target)
    Aˢ′ Aᵗ′ Bˢ′ Bᵗ′
advance-pending-span source-step target-step pending =
  advance-target target-step (advance-source source-step pending)

advance-accounting :
  ∀ { source target source-mode target-mode
      Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Aᵗ′ Bˢ′ Bᵗ′ }
    (source-step : EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′)
    (target-step : EndpointStep target-mode Aᵗ Bᵗ Aᵗ′ Bᵗ′)
    (pending : PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ) →
  PendingAccounting pending →
  PendingAccounting
    (advance-pending-span source-step target-step pending)
advance-accounting source-step target-step pending accounting =
  advance-target-accounting target-step (advance-source source-step pending)
    (advance-source-accounting source-step pending accounting)

data LocalReachability (source-base target-base : SpanWorld) :
    SpanWorld → SpanWorld → Ty → Ty → Ty → Ty → Set where
  local-reachable-root : ∀ {A B} →
    LocalReachability source-base target-base
      source-base target-base A A B B

  local-reachable-paired :
    ∀ { source target source-mode target-mode
        Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Aᵗ′ Bˢ′ Bᵗ′ } →
    EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
    EndpointStep target-mode Aᵗ Bᵗ Aᵗ′ Bᵗ′ →
  ...
  local-reachable-source :
    ∀ { source target source-mode
        Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Bˢ′ } →
    EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
    LocalReachability source-base target-base
      source target Aˢ Aᵗ Bˢ Bᵗ →
    LocalReachability source-base target-base
      (world-extend source-mode source) target
      Aˢ′ Aᵗ Bˢ′ Bᵗ

local-reachability-pending :
  ∀ {source-base target-base source target Aˢ Aᵗ Bˢ Bᵗ} →
  LocalReachability source-base target-base
    source target Aˢ Aᵗ Bˢ Bᵗ →
  PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ
local-reachability-pending local-reachable-root =
  pending-span alignment-refl alignment-refl
local-reachability-pending
    (local-reachable-paired source-step target-step reachable) =
  advance-pending-span source-step target-step
    (local-reachability-pending reachable)
local-reachability-pending
    (local-reachable-source source-step reachable) =
  advance-source source-step (local-reachability-pending reachable)

local-source-step-count :
  ∀ {source-base target-base source target Aˢ Aᵗ Bˢ Bᵗ} →
  LocalReachability source-base target-base
    source target Aˢ Aᵗ Bˢ Bᵗ →
  ℕ
local-source-step-count local-reachable-root = zero
local-source-step-count
    (local-reachable-paired source-step target-step reachable) =
  suc (local-source-step-count reachable)
local-source-step-count
    (local-reachable-source source-step reachable) =
  suc (local-source-step-count reachable)

local-target-step-count :
  ∀ {source-base target-base source target Aˢ Aᵗ Bˢ Bᵗ} →
  LocalReachability source-base target-base
    source target Aˢ Aᵗ Bˢ Bᵗ →
  ℕ
local-target-step-count local-reachable-root = zero
local-target-step-count
    (local-reachable-paired source-step target-step reachable) =
  suc (local-target-step-count reachable)
local-target-step-count
    (local-reachable-source source-step reachable) =
  local-target-step-count reachable

≤-suc-right : ∀ {m n} → m ≤ n → m ≤ suc n
≤-suc-right z≤n = z≤n
≤-suc-right (s≤s m≤n) = s≤s (≤-suc-right m≤n)

local-target-steps≤source :
  ∀ {source-base target-base source target Aˢ Aᵗ Bˢ Bᵗ}
    (reachable : LocalReachability source-base target-base
      source target Aˢ Aᵗ Bˢ Bᵗ) →
  local-target-step-count reachable ≤
  local-source-step-count reachable
local-target-steps≤source local-reachable-root = z≤n
local-target-steps≤source
    (local-reachable-paired source-step target-step reachable) =
  s≤s (local-target-steps≤source reachable)
local-target-steps≤source
    (local-reachable-source source-step reachable) =
  ≤-suc-right (local-target-steps≤source reachable)

record LocalFactorState
    (source-world target-world : SpanWorld)
    (fuel : ℕ) (C D Aˢ Aᵗ Bˢ Bᵗ : Ty) : Set where
  constructor local-factor-state
  field
    local-pending :
      PendingSpan source-world target-world Aˢ Aᵗ Bˢ Bᵗ
    local-source :
      PairedLower
        (world-context source-world)
        (world-common-depth source-world)
...
open LocalFactorState

initial-local-factor-state :
  ...
  EnumRoute fuel
    ...
    (world-right-depth target)
    A B D →
  LocalFactorState source target fuel C D A A B B
initial-local-factor-state source target =
  local-factor-state (pending-span alignment-refl alignment-refl)
    source target

local-factor-swap-left-right :
  ∀ {source target fuel C D A Aᵗ B Bᵗ} →
  PendingSpan source target (`∀ A) Aᵗ (`∀ B) Bᵗ →
  occurs zero (`∀ C) ≡ true →
  occurs zero C ≡ true →
  PairedLower
    (extend-span rightˢ (extend-span leftˢ (world-context source)))
    (suc (suc (world-common-depth source)))
    C A B
    (suc (world-left-depth source))
    (suc (world-right-depth source)) →
  EnumRoute fuel
    (left-context (world-context target))
    (right-context (world-context target))
    (world-common-depth target)
  ...
  (`∀ (`∀ C)) ≈∀
    (`∀ (`∀ (renameᵗ ForallPermutation.swap01ᵗ C))) ×
  LocalFactorState source target fuel
    (`∀ (`∀ (renameᵗ ForallPermutation.swap01ᵗ C))) D
    (`∀ A) Aᵗ (`∀ B) Bᵗ
local-factor-swap-left-right pending outer-occ inner-occ lower target-route =
  ≈∀-swap ,
  local-factor-state pending
    (paired-lower-swap-left-right outer-occ inner-occ lower)
    target-route

local-factor-swap-right-left :
  ∀ {source target fuel C D A Aᵗ B Bᵗ} →
  PendingSpan source target (`∀ A) Aᵗ (`∀ B) Bᵗ →
  occurs zero (`∀ C) ≡ true →
  occurs zero C ≡ true →
  PairedLower
    (extend-span leftˢ (extend-span rightˢ (world-context source)))
    (suc (suc (world-common-depth source)))
    C A B
    (suc (world-left-depth source))
    (suc (world-right-depth source)) →
  ...
  LocalFactorState source target fuel
    (`∀ (`∀ (renameᵗ ForallPermutation.swap01ᵗ C))) D
    (`∀ A) Aᵗ (`∀ B) Bᵗ
local-factor-swap-right-left pending outer-occ inner-occ lower target-route =
  ≈∀-swap ,
  local-factor-state pending
    (paired-lower-swap-right-left outer-occ inner-occ lower)
    target-route

advance-local-factor-state :
  ∀ { source target source-mode target-mode fuel C D
      Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Aᵗ′ Bˢ′ Bᵗ′ } →
  PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ →
  EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
  EndpointStep target-mode Aᵗ Bᵗ Aᵗ′ Bᵗ′ →
  PairedLower
    (world-context (world-extend source-mode source))
    (world-common-depth (world-extend source-mode source))
    C Aˢ′ Bˢ′
    (world-left-depth (world-extend source-mode source))
    (world-right-depth (world-extend source-mode source)) →
  EnumRoute fuel
    (left-context (world-context (world-extend target-mode target)))
    (right-context (world-context (world-extend target-mode target)))
    (world-common-depth (world-extend target-mode target))
    (world-left-depth (world-extend target-mode target))
    (world-right-depth (world-extend target-mode target))
    Aᵗ′ Bᵗ′ D →
  LocalFactorState
    (world-extend source-mode source)
    (world-extend target-mode target)
    fuel C D Aˢ′ Aᵗ′ Bˢ′ Bᵗ′
advance-local-factor-state pending source-step target-step source target =
  local-factor-state
    (advance-pending-span source-step target-step pending)
    source target

advance-local-source-state :
  ∀ { source target source-mode fuel C D
      Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Bˢ′ } →
  PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ →
  EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
  PairedLower
  ...
  LocalFactorState
    (world-extend source-mode source) target
    fuel C D Aˢ′ Aᵗ Bˢ′ Bᵗ
advance-local-source-state pending source-step source target =
  local-factor-state (advance-source source-step pending) source target

record ReachableLocalFactorState
    (source-base target-base source target : SpanWorld)
    (fuel : ℕ) (C D Aˢ Aᵗ Bˢ Bᵗ : Ty) : Set where
  constructor reachable-local-factor-state
  field
    local-reachability :
      LocalReachability source-base target-base
        source target Aˢ Aᵗ Bˢ Bᵗ
    reachable-local-state :
      LocalFactorState source target fuel C D Aˢ Aᵗ Bˢ Bᵗ

open ReachableLocalFactorState

initial-reachable-local-factor-state :
  ∀ {source target fuel C D A B} →
  PairedLower
    (world-context source)
    (world-common-depth source)
  ...
  EnumRoute fuel
    ...
    (world-right-depth target)
    A B D →
  ReachableLocalFactorState source target source target
    fuel C D A A B B
initial-reachable-local-factor-state source target =
  reachable-local-factor-state local-reachable-root
    (initial-local-factor-state source target)

advance-reachable-local-factor-state :
  ∀ { source-base target-base source target
      source-mode target-mode fuel C D
      Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Aᵗ′ Bˢ′ Bᵗ′ } →
  ReachableLocalFactorState source-base target-base source target
    (suc fuel) (`∀ C) (`∀ D) Aˢ Aᵗ Bˢ Bᵗ →
  EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
  EndpointStep target-mode Aᵗ Bᵗ Aᵗ′ Bᵗ′ →
  PairedLower
    (world-context (world-extend source-mode source))
  ...
  EnumRoute fuel
    ...
    (world-right-depth (world-extend target-mode target))
    Aᵗ′ Bᵗ′ D →
  ReachableLocalFactorState source-base target-base
    (world-extend source-mode source)
    (world-extend target-mode target)
    fuel C D Aˢ′ Aᵗ′ Bˢ′ Bᵗ′
advance-reachable-local-factor-state state source-step target-step
    source target =
  reachable-local-factor-state
    (local-reachable-paired source-step target-step
      (local-reachability state))
    (advance-local-factor-state
      (local-pending (reachable-local-state state))
      source-step target-step source target)

advance-reachable-local-source-state :
  ∀ { source-base target-base source target source-mode
      fuel C D Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Bˢ′ } →
  ReachableLocalFactorState source-base target-base source target
    fuel (`∀ C) D Aˢ Aᵗ Bˢ Bᵗ →
  EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
  PairedLower
  ...
  ReachableLocalFactorState source-base target-base
    (world-extend source-mode source) target
    fuel C D Aˢ′ Aᵗ Bˢ′ Bᵗ
advance-reachable-local-source-state state source-step source target =
  reachable-local-factor-state
    (local-reachable-source source-step (local-reachability state))
    (advance-local-source-state
      (local-pending (reachable-local-state state))
      source-step source target)

data PendingTrace (source-root target-root : SpanRoot) :
    SpanWorld → SpanWorld → Ty → Ty → Ty → Ty → Set where
  trace-root :
    ∀ {A B} →
    PendingTrace source-root target-root
      (world-root source-root) (world-root target-root) A A B B
...
trace-pending-span :
  ∀ { source-root target-root source target Aˢ Aᵗ Bˢ Bᵗ } →
  PendingTrace source-root target-root
    source target Aˢ Aᵗ Bˢ Bᵗ →
  PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ
trace-pending-span trace-root = initial-pending-span
trace-pending-span (trace-step source-step target-step trace) =
  advance-pending-span source-step target-step
    (trace-pending-span trace)

trace-local-reachability :
  ∀ { source-root target-root source target Aˢ Aᵗ Bˢ Bᵗ } →
  PendingTrace source-root target-root
    source target Aˢ Aᵗ Bˢ Bᵗ →
  LocalReachability (world-root source-root) (world-root target-root)
    source target Aˢ Aᵗ Bˢ Bᵗ
trace-local-reachability trace-root = local-reachable-root
trace-local-reachability (trace-step source-step target-step trace) =
  local-reachable-paired source-step target-step
    (trace-local-reachability trace)

trace-accounting :
  ∀ { source-root target-root source target Aˢ Aᵗ Bˢ Bᵗ }
    (trace : PendingTrace source-root target-root
      source target Aˢ Aᵗ Bˢ Bᵗ) →
  PendingAccounting (trace-pending-span trace)
trace-accounting trace-root = initial-accounting
trace-accounting (trace-step source-step target-step trace) =
  advance-accounting source-step target-step (trace-pending-span trace)
    (trace-accounting trace)

trace-exposure-count :
  ∀ { source-root target-root source target Aˢ Aᵗ Bˢ Bᵗ } →
  PendingTrace source-root target-root
    source target Aˢ Aᵗ Bˢ Bᵗ →
  world-exposure-count source ≡ world-exposure-count target
trace-exposure-count trace-root = refl
trace-exposure-count (trace-step source-step target-step trace) =
  cong suc (trace-exposure-count trace)

record FactorState
    (source-root target-root : SpanRoot)
    (source-world target-world : SpanWorld)
    (fuel : ℕ) (C D Aˢ Aᵗ Bˢ Bᵗ : Ty) : Set where
  constructor factor-state
  field
    factor-trace :
      PendingTrace source-root target-root source-world target-world
        Aˢ Aᵗ Bˢ Bᵗ
    factor-source :
      PairedLower
        (world-context source-world)
...
factor-state-to-local :
  ∀ { source-root target-root source target fuel
      C D Aˢ Aᵗ Bˢ Bᵗ } →
  FactorState source-root target-root source target fuel
    C D Aˢ Aᵗ Bˢ Bᵗ →
  LocalFactorState source target fuel C D Aˢ Aᵗ Bˢ Bᵗ
factor-state-to-local state =
  local-factor-state
    (trace-pending-span (factor-trace state))
    (factor-source state)
    (factor-target state)

factor-state-to-reachable-local :
  ∀ { source-root target-root source target fuel
      C D Aˢ Aᵗ Bˢ Bᵗ } →
  FactorState source-root target-root source target fuel
    C D Aˢ Aᵗ Bˢ Bᵗ →
  ReachableLocalFactorState
    (world-root source-root) (world-root target-root)
    source target fuel C D Aˢ Aᵗ Bˢ Bᵗ
factor-state-to-reachable-local state =
  reachable-local-factor-state
    (trace-local-reachability (factor-trace state))
    (factor-state-to-local state)

initial-factor-state :
  ∀ {source-root target-root fuel C D A B} →
  PairedLower
    (root-context source-root) (root-common-depth source-root)
    C A B (root-left-depth source-root) (root-right-depth source-root) →
  EnumRoute fuel
    (left-context (root-context target-root))
    (right-context (root-context target-root))
    (root-common-depth target-root)
    (root-left-depth target-root)
    (root-right-depth target-root) A B D →
  FactorState source-root target-root
    (world-root source-root) (world-root target-root)
    fuel C D A A B B
initial-factor-state source target =
  factor-state trace-root source target

advance-factor-state :
  ∀ { source-root target-root source-world target-world
      source-mode target-mode fuel C D
      Aˢ Aᵗ Bˢ Bᵗ Aˢ′ Aᵗ′ Bˢ′ Bᵗ′ } →
  (trace : PendingTrace source-root target-root
    source-world target-world Aˢ Aᵗ Bˢ Bᵗ) →
  EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
  EndpointStep target-mode Aᵗ Bᵗ Aᵗ′ Bᵗ′ →
  PairedLower
    (world-context (world-extend source-mode source-world))
    (world-common-depth (world-extend source-mode source-world))
    C Aˢ′ Bˢ′
    (world-left-depth (world-extend source-mode source-world))
    (world-right-depth (world-extend source-mode source-world)) →
  EnumRoute fuel
    (left-context
      (world-context (world-extend target-mode target-world)))
    (right-context
      (world-context (world-extend target-mode target-world)))
    (world-common-depth (world-extend target-mode target-world))
    (world-left-depth (world-extend target-mode target-world))
    (world-right-depth (world-extend target-mode target-world))
    Aᵗ′ Bᵗ′ D →
  FactorState source-root target-root
    (world-extend source-mode source-world)
    (world-extend target-mode target-world)
    fuel C D Aˢ′ Aᵗ′ Bˢ′ Bᵗ′
advance-factor-state trace source-step target-step source target =
  factor-state (trace-step source-step target-step trace) source target
...
normalize-neither-state :
  ∀ { source-root target-root source-world target-world
      fuel C D Aˢ Aᵗ Bˢ Bᵗ } →
  (trace : PendingTrace source-root target-root
    source-world target-world Aˢ Aᵗ Bˢ Bᵗ) →
  PairedLower
    (extend-span neitherˢ (world-context source-world))
    (suc (world-common-depth source-world))
    C Aˢ Bˢ
    (world-left-depth source-world)
    (world-right-depth source-world) →
  EnumRoute fuel
    ...
    (world-right-depth target-world)
    Aᵗ Bᵗ D →
  FactorState source-root target-root source-world target-world
    fuel (C [ ★ ]ᵗ) D Aˢ Aᵗ Bˢ Bᵗ
normalize-neither-state trace source target =
  factor-state trace (paired-inst-star source) target

both-left-trace :
  ∀ {source target A B} →
  PendingTrace source target
    (world-extend bothˢ (world-root source))
    (world-extend leftˢ (world-root target))
    A A B (`∀ B)
both-left-trace = trace-step step-both step-left trace-root
...
crossed-trace :
  ...
  PendingTrace source target
    ...
    A A B B
crossed-trace =
  trace-step step-right step-left
    (trace-step step-left step-right trace-root)

data NonForall : Ty → Set where
  non-★ : NonForall ★
  non-var : ∀ {X} → NonForall (＇ X)
  non-base : ∀ {ι} → NonForall (‵ ι)
  non-arrow : ∀ {A B} → NonForall (A ⇒ B)
...
data PairedVariableSpine : Ty → Ty → Set where
  variable-here : ∀ {X Y} →
    PairedVariableSpine (＇ X) (＇ Y)
  variable-under : ∀ {A B} →
    PairedVariableSpine A B →
    PairedVariableSpine (`∀ A) (`∀ B)

data PairedStructuralSpine : Ty → Ty → Set where
  structural-here : ∀ {C D} →
    BinderFree C →
    NonForall D →
    PairedStructuralSpine C D

  structural-under : ∀ {C D} →
    PairedStructuralSpine C D →
    PairedStructuralSpine (`∀ C) (`∀ D)

data SourceStructuralSpine : Ty → Ty → Set where
  source-structural-here : ∀ {C D} →
    BinderFree C →
    NonForall D →
    SourceStructuralSpine C D

  source-structural-under : ∀ {C D} →
    occurs zero C ≡ true →
    SourceStructuralSpine C D →
    SourceStructuralSpine (`∀ C) D

data FactorSpine : Ty → Ty → Set where
  paired-factor-spine : ∀ {C D} →
    PairedStructuralSpine C D →
    FactorSpine C D

  source-factor-spine : ∀ {C D} →
    SourceStructuralSpine C D →
    FactorSpine C D

data FactorStructure : Ty → Ty → Set where
  factor-structure-terminal : ∀ {C D} →
    BinderFree C →
    NonForall D →
    FactorStructure C D

  factor-structure-spine : ∀ {C D} →
    FactorSpine C D →
    FactorStructure C D

  factor-structure-arrow : ∀ {C₁ C₂ D₁ D₂} →
    FactorStructure C₁ D₁ →
    FactorStructure C₂ D₂ →
    FactorStructure (C₁ ⇒ C₂) (D₁ ⇒ D₂)

  factor-structure-arrow-star : ∀ {C₁ C₂} →
    FactorStructure C₁ ★ →
    FactorStructure C₂ ★ →
    FactorStructure (C₁ ⇒ C₂) ★

data RecursiveFactorStructure : Ty → Ty → Set where
  recursive-terminal : ∀ {C D} →
    BinderFree C →
    NonForall D →
    RecursiveFactorStructure C D

  recursive-arrow : ∀ {C₁ C₂ D₁ D₂} →
    RecursiveFactorStructure C₁ D₁ →
    RecursiveFactorStructure C₂ D₂ →
    RecursiveFactorStructure (C₁ ⇒ C₂) (D₁ ⇒ D₂)

  recursive-arrow-star : ∀ {C₁ C₂} →
    RecursiveFactorStructure C₁ ★ →
    RecursiveFactorStructure C₂ ★ →
    RecursiveFactorStructure (C₁ ⇒ C₂) ★

  recursive-forall : ∀ {C D} →
    RecursiveFactorStructure C D →
    RecursiveFactorStructure (`∀ C) (`∀ D)

  recursive-source-forall : ∀ {C D} →
    occurs zero C ≡ true →
    RecursiveFactorStructure C D →
    RecursiveFactorStructure (`∀ C) D

binder-free? : ∀ C → Maybe (BinderFree C)
binder-free? ★ = just free-★
binder-free? (＇ X) = just free-var
binder-free? (‵ ι) = just free-base
binder-free? (C₁ ⇒ C₂) with binder-free? C₁ | binder-free? C₂
binder-free? (C₁ ⇒ C₂) | just free₁ | just free₂ =
  just (free-arrow free₁ free₂)
binder-free? (C₁ ⇒ C₂) | just free₁ | nothing = nothing
binder-free? (C₁ ⇒ C₂) | nothing | just free₂ = nothing
binder-free? (C₁ ⇒ C₂) | nothing | nothing = nothing
binder-free? (`∀ C) = nothing

non-forall? : ∀ C → Maybe (NonForall C)
non-forall? ★ = just non-★
non-forall? (＇ X) = just non-var
non-forall? (‵ ι) = just non-base
non-forall? (C₁ ⇒ C₂) = just non-arrow
non-forall? (`∀ C) = nothing

mutual
  recursive-structure? :
    ∀ C D → Maybe (RecursiveFactorStructure C D)
  recursive-structure? C D with binder-free? C | non-forall? D
  recursive-structure? C D | just free | just non-D =
    just (recursive-terminal free non-D)
  recursive-structure? C D | just free | nothing =
    recursive-nonterminal-structure? C D
  recursive-structure? C D | nothing | just non-D =
    recursive-nonterminal-structure? C D
  recursive-structure? C D | nothing | nothing =
    recursive-nonterminal-structure? C D

  recursive-nonterminal-structure? :
    ∀ C D → Maybe (RecursiveFactorStructure C D)
  recursive-nonterminal-structure? ★ ★ = nothing
  recursive-nonterminal-structure? ★ (＇ Y) = nothing
  recursive-nonterminal-structure? ★ (‵ ι) = nothing
  recursive-nonterminal-structure? ★ (D₁ ⇒ D₂) = nothing
  recursive-nonterminal-structure? ★ (`∀ D) = nothing
  recursive-nonterminal-structure? (＇ X) ★ = nothing
  recursive-nonterminal-structure? (＇ X) (＇ Y) = nothing
  recursive-nonterminal-structure? (＇ X) (‵ ι) = nothing
  recursive-nonterminal-structure? (＇ X) (D₁ ⇒ D₂) = nothing
  recursive-nonterminal-structure? (＇ X) (`∀ D) = nothing
  recursive-nonterminal-structure? (‵ ι) ★ = nothing
  recursive-nonterminal-structure? (‵ ι) (＇ Y) = nothing
  recursive-nonterminal-structure? (‵ ι) (‵ ι′) = nothing
  recursive-nonterminal-structure? (‵ ι) (D₁ ⇒ D₂) = nothing
  recursive-nonterminal-structure? (‵ ι) (`∀ D) = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) ★
      with recursive-structure? C₁ ★ | recursive-structure? C₂ ★
  recursive-nonterminal-structure? (C₁ ⇒ C₂) ★
      | just factor₁ | just factor₂ =
    just (recursive-arrow-star factor₁ factor₂)
  recursive-nonterminal-structure? (C₁ ⇒ C₂) ★
      | just factor₁ | nothing = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) ★
      | nothing | just factor₂ = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) ★
      | nothing | nothing = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) (＇ Y) = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) (‵ ι) = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) (D₁ ⇒ D₂)
      with recursive-structure? C₁ D₁
         | recursive-structure? C₂ D₂
  recursive-nonterminal-structure? (C₁ ⇒ C₂) (D₁ ⇒ D₂)
      | just factor₁ | just factor₂ =
    just (recursive-arrow factor₁ factor₂)
  recursive-nonterminal-structure? (C₁ ⇒ C₂) (D₁ ⇒ D₂)
      | just factor₁ | nothing = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) (D₁ ⇒ D₂)
      | nothing | just factor₂ = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) (D₁ ⇒ D₂)
      | nothing | nothing = nothing
  recursive-nonterminal-structure? (C₁ ⇒ C₂) (`∀ D) = nothing
  recursive-nonterminal-structure? (`∀ C) ★ =
    recursive-source-forall-structure? C ★
  recursive-nonterminal-structure? (`∀ C) (＇ Y) =
    recursive-source-forall-structure? C (＇ Y)
  recursive-nonterminal-structure? (`∀ C) (‵ ι) =
    recursive-source-forall-structure? C (‵ ι)
  recursive-nonterminal-structure? (`∀ C) (D₁ ⇒ D₂) =
    recursive-source-forall-structure? C (D₁ ⇒ D₂)
  recursive-nonterminal-structure? (`∀ C) (`∀ D)
      with recursive-structure? C D
  recursive-nonterminal-structure? (`∀ C) (`∀ D)
      | just factor = just (recursive-forall factor)
  recursive-nonterminal-structure? (`∀ C) (`∀ D)
      | nothing = recursive-source-forall-structure? C (`∀ D)

  recursive-source-forall-structure? :
    ∀ C D → Maybe (RecursiveFactorStructure (`∀ C) D)
  recursive-source-forall-structure? C D with occurs zero C in occ
  recursive-source-forall-structure? C D | false = nothing
  recursive-source-forall-structure? C D | true
      with recursive-structure? C D
  recursive-source-forall-structure? C D | true | just factor =
    just (recursive-source-forall occ factor)
  recursive-source-forall-structure? C D | true | nothing = nothing

recursive-structure-source-fallback-test :
  recursive-structure?
    (`∀ (`∀ (＇ (suc zero)))) (`∀ ★) ≡
  just
    (recursive-source-forall refl
      (recursive-forall (recursive-terminal free-var non-★)))
recursive-structure-source-fallback-test = refl

data VariableSpineFactor : SpanWorld → SpanWorld → ℕ →
    Ty → Ty → Ty → Ty → Ty → Ty → Set where
  spine-variable :
    ∀ {source target fuel Z W Aˢ Aᵗ Bˢ Bᵗ} →
    Z < world-common-depth source →
    W < world-common-depth target →
    PullsBack source target Z W →
    VariableSpineFactor source target fuel
      (＇ Z) (＇ W) Aˢ Aᵗ Bˢ Bᵗ
  ...
  spine-binder :
    ...
    VariableSpineFactor
      ...
      (world-extend target-mode target)
      fuel C D Aˢ′ Aᵗ′ Bˢ′ Bᵗ′ →
    VariableSpineFactor source target
      (suc fuel) (`∀ C) (`∀ D) Aˢ Aᵗ Bˢ Bᵗ

data StructuralSpineFactor : SpanWorld → SpanWorld → ℕ →
    Ty → Ty → Ty → Ty → Ty → Ty → Set where
  structural-terminal :
    ∀ {source target fuel C D Aˢ Aᵗ Bˢ Bᵗ} →
    DirectTerminalFactor source target C D →
    StructuralSpineFactor source target fuel C D Aˢ Aᵗ Bˢ Bᵗ
  ...
  structural-binder :
    ...
    EndpointStep source-mode Aˢ Bˢ Aˢ′ Bˢ′ →
    EndpointStep target-mode Aᵗ Bᵗ Aᵗ′ Bᵗ′ →
    StructuralSpineFactor
      (world-extend source-mode source)
      (world-extend target-mode target)
      fuel C D Aˢ′ Aᵗ′ Bˢ′ Bᵗ′ →
    StructuralSpineFactor source target
      (suc fuel) (`∀ C) (`∀ D) Aˢ Aᵗ Bˢ Bᵗ

data WorldFactor (source target : SpanWorld) : Ty → Ty → Set where
  world-star : WorldFactor source target ★ ★

  world-base : ∀ {ι} →
    WorldFactor source target (‵ ι) (‵ ι)

  world-base-star : ∀ {ι} →
    WorldFactor source target (‵ ι) ★

  world-arrow : ∀ {C₁ C₂ D₁ D₂} →
    WorldFactor source target C₁ D₁ →
    WorldFactor source target C₂ D₂ →
    WorldFactor source target (C₁ ⇒ C₂) (D₁ ⇒ D₂)

  world-arrow-star : ∀ {C₁ C₂} →
    WorldFactor source target C₁ ★ →
    WorldFactor source target C₂ ★ →
    WorldFactor source target (C₁ ⇒ C₂) ★

  world-variable : ∀ {Z W} →
    Z < world-common-depth source →
    W < world-common-depth target →
    PullsBack source target Z W →
    WorldFactor source target (＇ Z) (＇ W)

  world-variable-star : ∀ {Z} →
    Z < world-common-depth source →
    WorldRow source Z ★ᵛ ★ᵛ →
    WorldFactor source target (＇ Z) ★

  world-forall :
    ∀ {source-mode target-mode C D} →
    WorldFactor
      (world-extend source-mode source)
      (world-extend target-mode target)
      C D →
  ...
  world-source-forall : ∀ {source-mode C D} →
    occurs zero C ≡ true →
    WorldFactor (world-extend source-mode source) target C D →
    WorldFactor source target (`∀ C) D

data IndexedWorldFactor
    (source target : SpanWorld) (Ψ : ImpCtx) (Δˢ Δᵗ : TyCtx) :
    Ty → Ty → Set where
  indexed-world-star :
    IndexedWorldFactor source target Ψ Δˢ Δᵗ ★ ★

  indexed-world-base : ∀ {ι} →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ (‵ ι) (‵ ι)

  indexed-world-base-star : ∀ {ι} →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ (‵ ι) ★

  indexed-world-arrow : ∀ {C₁ C₂ D₁ D₂} →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ C₁ D₁ →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ C₂ D₂ →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ
      (C₁ ⇒ C₂) (D₁ ⇒ D₂)

  indexed-world-arrow-star : ∀ {C₁ C₂} →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ C₁ ★ →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ C₂ ★ →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ (C₁ ⇒ C₂) ★

  indexed-world-variable : ∀ {Z W} →
    (Z ˣ⊑ˣ W) ∈ Ψ →
    Z < Δˢ →
    W < Δᵗ →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ (＇ Z) (＇ W)

  indexed-world-variable-star : ∀ {Z} →
    (Z ˣ⊑★) ∈ Ψ →
    Z < Δˢ →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ (＇ Z) ★

  indexed-world-forall :
    ∀ {source-mode target-mode C D} →
    IndexedWorldFactor
      (world-extend source-mode source)
      (world-extend target-mode target)
      (∀ᵢᶜ Ψ) (suc Δˢ) (suc Δᵗ) C D →
    IndexedWorldFactor source target Ψ Δˢ Δᵗ (`∀ C) (`∀ D)

  indexed-world-source-forall : ∀ {source-mode C D} →
    occurs zero C ≡ true →
    IndexedWorldFactor
      (world-extend source-mode source) target
      (νᵢᶜ Ψ) (suc Δˢ) Δᵗ C D →
...
indexed-world-factor-imprecision :
  ∀ {source target Ψ Δˢ Δᵗ C D} →
  IndexedWorldFactor source target Ψ Δˢ Δᵗ C D →
  Ψ ∣ Δˢ ⊢ C ⊑ D ⊣ Δᵗ
indexed-world-factor-imprecision indexed-world-star = id★
indexed-world-factor-imprecision indexed-world-base = idι
indexed-world-factor-imprecision indexed-world-base-star = tag _
indexed-world-factor-imprecision
    (indexed-world-arrow factor₁ factor₂) =
  indexed-world-factor-imprecision factor₁ ↦
  indexed-world-factor-imprecision factor₂
indexed-world-factor-imprecision
    (indexed-world-arrow-star factor₁ factor₂) =
  tag indexed-world-factor-imprecision factor₁ ⇛
  indexed-world-factor-imprecision factor₂
indexed-world-factor-imprecision
    (indexed-world-variable Z⊑W Z<Δ W<Δ) =
  idˣ Z⊑W Z<Δ W<Δ
indexed-world-factor-imprecision
    (indexed-world-variable-star Z⊑★ Z<Δ) =
  tagˣ Z⊑★ Z<Δ
indexed-world-factor-imprecision (indexed-world-forall factor) =
  ∀ⁱ indexed-world-factor-imprecision factor
indexed-world-factor-imprecision
    (indexed-world-source-forall occ factor) =
  ν occ (indexed-world-factor-imprecision factor)

indexed-world-factor-occurs-zero-∀ :
  ∀ {source target Ψ Δˢ Δᵗ C D} →
  IndexedWorldFactor source target
    (∀ᵢᶜ Ψ) (suc Δˢ) (suc Δᵗ) C D →
  occurs zero C ≡ true →
  occurs zero D ≡ true
indexed-world-factor-occurs-zero-∀ factor =
  occurs-zero-factor-∀ (indexed-world-factor-imprecision factor)

combine-arrow-route-factors :
  ∀ { source target Ψ Δˢ Δᵗ fuel C₁ C₂
      A₁ A₂ B₁ B₂ } →
  (∃[ D₁ ]
    (EnumRoute fuel
      (left-context (world-context target))
  ...
  ∃[ D ]
    (EnumRoute (suc fuel)
      ...
      (world-right-depth target)
      (A₁ ⇒ A₂) (B₁ ⇒ B₂) D ×
     IndexedWorldFactor source target Ψ Δˢ Δᵗ (C₁ ⇒ C₂) D)
combine-arrow-route-factors
    (D₁ , route₁ , factor₁) (D₂ , route₂ , factor₂) =
  D₁ ⇒ D₂ , route-arrow route₁ route₂ ,
  indexed-world-arrow factor₁ factor₂

combine-arrow-star-route-factors :
  ∀ {source target Ψ Δˢ Δᵗ fuel C₁ C₂ A₁ A₂} →
  (∃[ D₁ ]
    (EnumRoute fuel
      (left-context (world-context target))
      (right-context (world-context target))
...
combine-arrow-star-route-factors
    (D₁ , route₁ , factor₁) (D₂ , route₂ , factor₂) =
  D₁ ⇒ D₂ , route-arrow-star route₁ route₂ ,
  indexed-world-arrow factor₁ factor₂

combine-star-arrow-route-factors :
  ∀ {source target Ψ Δˢ Δᵗ fuel C₁ C₂ B₁ B₂} →
  (∃[ D₁ ]
    (EnumRoute fuel
      (left-context (world-context target))
      (right-context (world-context target))
...
combine-star-arrow-route-factors
    (D₁ , route₁ , factor₁) (D₂ , route₂ , factor₂) =
  D₁ ⇒ D₂ , route-star-arrow route₁ route₂ ,
  indexed-world-arrow factor₁ factor₂

combine-both-forall-route-factor :
  ∀ { source target Ψ Δˢ Δᵗ source-mode fuel C A B } →
  (∃[ D ]
    (EnumRoute fuel
      (left-context (world-context (world-extend bothˢ target)))
      (right-context (world-context (world-extend bothˢ target)))
      (world-common-depth (world-extend bothˢ target))
      (world-left-depth (world-extend bothˢ target))
      (world-right-depth (world-extend bothˢ target))
      A B D ×
     IndexedWorldFactor
       (world-extend source-mode source)
       (world-extend bothˢ target)
       (∀ᵢᶜ Ψ) (suc Δˢ) (suc Δᵗ) C D)) →
  ∃[ D ]
    (EnumRoute (suc fuel)
      (left-context (world-context target))
      ...
      (`∀ A) (`∀ B) D ×
     IndexedWorldFactor source target Ψ Δˢ Δᵗ (`∀ C) D)
combine-both-forall-route-factor (D , route , factor) =
  `∀ D , route-both route , indexed-world-forall factor

combine-left-forall-route-factor :
  ∀ { source target Ψ Δˢ Δᵗ source-mode fuel C A B } →
  occurs zero C ≡ true →
  (∃[ D ]
    (EnumRoute fuel
  ...
  ∃[ D ]
    (EnumRoute (suc fuel)
      ...
      (`∀ A) B D ×
     IndexedWorldFactor source target Ψ Δˢ Δᵗ (`∀ C) D)
combine-left-forall-route-factor occ (D , route , factor) =
  `∀ D ,
  route-left (indexed-world-factor-occurs-zero-∀ factor occ) route ,
  indexed-world-forall factor

combine-right-forall-route-factor :
  ∀ { source target Ψ Δˢ Δᵗ source-mode fuel C A B } →
  occurs zero C ≡ true →
  (∃[ D ]
    (EnumRoute fuel
  ...
  ∃[ D ]
    (EnumRoute (suc fuel)
      ...
      A (`∀ B) D ×
     IndexedWorldFactor source target Ψ Δˢ Δᵗ (`∀ C) D)
combine-right-forall-route-factor occ (D , route , factor) =
  `∀ D ,
  route-right (indexed-world-factor-occurs-zero-∀ factor occ) route ,
  indexed-world-forall factor

combine-source-forall-route-factor :
  ∀ {source target Ψ Δˢ Δᵗ source-mode fuel C A B} →
  occurs zero C ≡ true →
  (∃[ D ]
    (EnumRoute fuel
  ...
  ∃[ D ]
    (EnumRoute fuel
      ...
      A B D ×
     IndexedWorldFactor source target Ψ Δˢ Δᵗ (`∀ C) D)
combine-source-forall-route-factor occ (D , route , factor) =
  D , route , indexed-world-source-forall occ factor
...
root-binder-free-world-factor-imprecision :
  ∀ {Φ Δᴸ Δᴿ C D} →
  BinderFree C →
  WorldFactor
    (world-root (span-root (span Φ Φ) Δᴸ Δᴿ Δᴿ))
    ...
    C D →
  Φ ∣ Δᴸ ⊢ C ⊑ D ⊣ Δᴿ
root-binder-free-world-factor-imprecision free-★ world-star = id★
root-binder-free-world-factor-imprecision free-base world-base = idι
root-binder-free-world-factor-imprecision free-base world-base-star =
  tag _
root-binder-free-world-factor-imprecision
    (free-arrow free₁ free₂) (world-arrow factor₁ factor₂) =
  root-binder-free-world-factor-imprecision free₁ factor₁ ↦
  root-binder-free-world-factor-imprecision free₂ factor₂
root-binder-free-world-factor-imprecision
    (free-arrow free₁ free₂) (world-arrow-star factor₁ factor₂) =
  tag root-binder-free-world-factor-imprecision free₁ factor₁ ⇛
  root-binder-free-world-factor-imprecision free₂ factor₂
root-binder-free-world-factor-imprecision
    free-var (world-variable Z<Δ W<Δ pull) =
  idˣ (root-pullback-var pull) Z<Δ W<Δ
root-binder-free-world-factor-imprecision
    free-var (world-variable-star Z<Δ source-row) =
  tagˣ (root-source-star source-row) Z<Δ

root-binder-free-world-factor→indexed :
  ∀ {Φ Δᴸ Δᴿ C D} →
  BinderFree C →
  WorldFactor
    (world-root (span-root (span Φ Φ) Δᴸ Δᴿ Δᴿ))
  ...
  IndexedWorldFactor
    ...
    (world-root
      (span-root (span (idᵢ Δᴿ) (idᵢ Δᴿ)) Δᴿ Δᴿ Δᴿ))
    Φ Δᴸ Δᴿ C D
root-binder-free-world-factor→indexed free-★ world-star =
  indexed-world-star
root-binder-free-world-factor→indexed free-base world-base =
  indexed-world-base
root-binder-free-world-factor→indexed free-base world-base-star =
  indexed-world-base-star
root-binder-free-world-factor→indexed
    (free-arrow free₁ free₂) (world-arrow factor₁ factor₂) =
  indexed-world-arrow
    (root-binder-free-world-factor→indexed free₁ factor₁)
    (root-binder-free-world-factor→indexed free₂ factor₂)
root-binder-free-world-factor→indexed
    (free-arrow free₁ free₂) (world-arrow-star factor₁ factor₂) =
  indexed-world-arrow-star
    (root-binder-free-world-factor→indexed free₁ factor₁)
    (root-binder-free-world-factor→indexed free₂ factor₂)
root-binder-free-world-factor→indexed
    free-var (world-variable Z<Δ W<Δ pull) =
  indexed-world-variable (root-pullback-var pull) Z<Δ W<Δ
root-binder-free-world-factor→indexed
    free-var (world-variable-star Z<Δ source-row) =
  indexed-world-variable-star (root-source-star source-row) Z<Δ

terminal-prefix-unique :
  ∀ {O A B} →
  NonForall A →
  NonForall B →
  ForallPrefix O A →
  ForallPrefix O B →
  A ≡ B
terminal-prefix-unique non-A non-B prefix-here prefix-here = refl
terminal-prefix-unique () non-B prefix-here (prefix-∀ target)
terminal-prefix-unique non-A () (prefix-∀ source) prefix-here
terminal-prefix-unique non-A non-B
    (prefix-∀ source) (prefix-∀ target) =
  terminal-prefix-unique non-A non-B source target

terminal-prefix-count-unique :
  ∀ {O A B} →
  NonForall A →
  NonForall B →
  (source : ForallPrefix O A) →
  (target : ForallPrefix O B) →
  prefix-count source ≡ prefix-count target
terminal-prefix-count-unique non-A non-B prefix-here prefix-here = refl
terminal-prefix-count-unique () non-B prefix-here (prefix-∀ target)
terminal-prefix-count-unique non-A () (prefix-∀ source) prefix-here
terminal-prefix-count-unique non-A non-B
    (prefix-∀ source) (prefix-∀ target) =
  cong suc (terminal-prefix-count-unique non-A non-B source target)

terminal-alignment-unique :
  ∀ {Aˢ Aᵗ} →
  NonForall Aˢ →
  NonForall Aᵗ →
  EndpointAlignment Aˢ Aᵗ →
  Aˢ ≡ Aᵗ
terminal-alignment-unique non-source non-target
    (aligned-by O source target) =
  terminal-prefix-unique non-source non-target source target

terminal-alignment-count-unique :
  ∀ {Aˢ Aᵗ} →
  NonForall Aˢ →
  NonForall Aᵗ →
  (alignment : EndpointAlignment Aˢ Aᵗ) →
  prefix-count (source-prefix alignment) ≡
  prefix-count (target-prefix alignment)
terminal-alignment-count-unique non-source non-target
    (aligned-by O source target) =
  terminal-prefix-count-unique non-source non-target source target

terminal-pending-span-unique :
  ∀ {source target Aˢ Aᵗ Bˢ Bᵗ} →
  NonForall Aˢ →
  NonForall Aᵗ →
  NonForall Bˢ →
  ...
  PendingSpan source target Aˢ Aᵗ Bˢ Bᵗ →
  (Aˢ ≡ Aᵗ) × (Bˢ ≡ Bᵗ)
terminal-pending-span-unique non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ pending =
  terminal-alignment-unique non-Aˢ non-Aᵗ
    (left-alignment pending) ,
  terminal-alignment-unique non-Bˢ non-Bᵗ
    (right-alignment pending)

terminal-trace-counts :
  ∀ { source-root target-root source target Aˢ Aᵗ Bˢ Bᵗ } →
  NonForall Aˢ →
  NonForall Aᵗ →
  NonForall Bˢ →
  ...
  (trace : PendingTrace source-root target-root
    source target Aˢ Aᵗ Bˢ Bᵗ) →
  (world-left-count source ≡ world-left-count target) ×
  (world-right-count source ≡ world-right-count target)
terminal-trace-counts non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ trace =
  trans (sym (accounts-source-left accounting))
    (trans
      (terminal-alignment-count-unique non-Aˢ non-Aᵗ
        (left-alignment pending))
      (accounts-target-left accounting)) ,
  trans (sym (accounts-source-right accounting))
    (trans
      (terminal-alignment-count-unique non-Bˢ non-Bᵗ
        (right-alignment pending))
      (accounts-target-right accounting))
  where
    pending = trace-pending-span trace
    accounting = trace-accounting trace

terminal-trace-signature :
  ∀ { source-root target-root source target Aˢ Aᵗ Bˢ Bᵗ } →
  NonForall Aˢ →
  NonForall Aᵗ →
  NonForall Bˢ →
  ...
  (trace : PendingTrace source-root target-root
    source target Aˢ Aᵗ Bˢ Bᵗ) →
  world-signature source ≡ world-signature target
terminal-trace-signature non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ trace
    with terminal-trace-counts
      non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ trace
terminal-trace-signature non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ trace
    | left-counts , right-counts
    rewrite trace-exposure-count trace
          | left-counts
          | right-counts =
  refl

factor-state-terminal-endpoints :
  ∀ { source-root target-root source target fuel C D Aˢ Aᵗ Bˢ Bᵗ } →
  NonForall Aˢ →
  NonForall Aᵗ →
  NonForall Bˢ →
  NonForall Bᵗ →
  FactorState source-root target-root source target
    fuel C D Aˢ Aᵗ Bˢ Bᵗ →
  (Aˢ ≡ Aᵗ) × (Bˢ ≡ Bᵗ)
factor-state-terminal-endpoints non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ state =
  terminal-pending-span-unique non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ
    (trace-pending-span (factor-trace state))

factor-state-terminal-signature :
  ∀ { source-root target-root source target fuel C D Aˢ Aᵗ Bˢ Bᵗ } →
  NonForall Aˢ →
  NonForall Aᵗ →
  NonForall Bˢ →
  NonForall Bᵗ →
  (state : FactorState source-root target-root source target
    fuel C D Aˢ Aᵗ Bˢ Bᵗ) →
  world-signature source ≡ world-signature target
factor-state-terminal-signature non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ state =
  terminal-trace-signature non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ
    (factor-trace state)

factor-state-vars-pullback :
  ∀ { source-root target-root source target fuel
      Z W Xˢ Xᵗ Yˢ Yᵗ } →
  FactorState source-root target-root source target fuel
    (＇ Z) (＇ W) (＇ Xˢ) (＇ Xᵗ) (＇ Yˢ) (＇ Yᵗ) →
  ...
  (W < world-common-depth target) ×
  PullsBack source target Z W
factor-state-vars-pullback state
    with factor-state-terminal-endpoints
      non-var non-var non-var non-var state
factor-state-vars-pullback state | refl , refl =
  paired-route-var-var-pullback
    (factor-source state) (factor-target state)

factor-state-var-star-pullback :
  ∀ { source-root target-root source target fuel
      Z W Xˢ Xᵗ } →
  FactorState source-root target-root source target fuel
    (＇ Z) (＇ W) (＇ Xˢ) (＇ Xᵗ) ★ ★ →
  ...
  (W < world-common-depth target) ×
  PullsBack source target Z W
factor-state-var-star-pullback state
    with factor-state-terminal-endpoints
      non-var non-var non-★ non-★ state
factor-state-var-star-pullback state | refl , refl =
  paired-route-var-star-pullback
    (factor-source state) (factor-target state)

factor-state-star-var-pullback :
  ∀ { source-root target-root source target fuel
      Z W Yˢ Yᵗ } →
  FactorState source-root target-root source target fuel
    (＇ Z) (＇ W) ★ ★ (＇ Yˢ) (＇ Yᵗ) →
  ...
  (W < world-common-depth target) ×
  PullsBack source target Z W
factor-state-star-var-pullback state
    with factor-state-terminal-endpoints
      non-★ non-★ non-var non-var state
factor-state-star-var-pullback state | refl , refl =
  paired-route-star-var-pullback
    (factor-source state) (factor-target state)

local-state-terminal-endpoints :
  ∀ {source target fuel C D Aˢ Aᵗ Bˢ Bᵗ} →
  NonForall Aˢ →
  NonForall Aᵗ →
  NonForall Bˢ →
  ...
  LocalFactorState source target fuel C D Aˢ Aᵗ Bˢ Bᵗ →
  (Aˢ ≡ Aᵗ) × (Bˢ ≡ Bᵗ)
local-state-terminal-endpoints non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ state =
  terminal-pending-span-unique non-Aˢ non-Aᵗ non-Bˢ non-Bᵗ
    (local-pending state)

local-state-vars-pullback :
  ∀ {source target fuel Z W Xˢ Xᵗ Yˢ Yᵗ} →
  LocalFactorState source target fuel
    (＇ Z) (＇ W) (＇ Xˢ) (＇ Xᵗ) (＇ Yˢ) (＇ Yᵗ) →
  (Z < world-common-depth source) ×
  (W < world-common-depth target) ×
  PullsBack source target Z W
local-state-vars-pullback state
    with local-state-terminal-endpoints
      non-var non-var non-var non-var state
local-state-vars-pullback state | refl , refl =
  paired-route-var-var-pullback
    (local-source state) (local-target state)

local-state-var-star-pullback :
  ∀ {source target fuel Z W Xˢ Xᵗ} →
  LocalFactorState source target fuel
    (＇ Z) (＇ W) (＇ Xˢ) (＇ Xᵗ) ★ ★ →
  (Z < world-common-depth source) ×
  (W < world-common-depth target) ×
  PullsBack source target Z W
local-state-var-star-pullback state
    with local-state-terminal-endpoints
      non-var non-var non-★ non-★ state
local-state-var-star-pullback state | refl , refl =
  paired-route-var-star-pullback
    (local-source state) (local-target state)

local-state-star-var-pullback :
  ∀ {source target fuel Z W Yˢ Yᵗ} →
  LocalFactorState source target fuel
    (＇ Z) (＇ W) ★ ★ (＇ Yˢ) (＇ Yᵗ) →
  (Z < world-common-depth source) ×
  (W < world-common-depth target) ×
  PullsBack source target Z W
local-state-star-var-pullback state
    with local-state-terminal-endpoints
      non-★ non-★ non-var non-var state
local-state-star-var-pullback state | refl , refl =
  paired-route-star-var-pullback
    (local-source state) (local-target state)

var≢★ : ∀ {X : TyVar} → _≡_ {A = Ty} (＇ X) ★ → ⊥
var≢★ ()

★≢var : ∀ {X : TyVar} → _≡_ {A = Ty} ★ (＇ X) → ⊥
★≢var ()

route-vars-not-forall :
  ∀ {fuel Φᴸ Φᴿ Δᶜ Δᴸ Δᴿ X Y A} →
  EnumRoute fuel Φᴸ Φᴿ Δᶜ Δᴸ Δᴿ
    (＇ X) (＇ Y) (`∀ A) →
  ⊥
route-vars-not-forall
    {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {Δᶜ = Δᶜ}
    {X = X} {Y = Y} {A = A} (route-vars C∈)
    with var-candidate-member-shape
      {limit = Δᶜ} {Φᴸ = Φᴸ} {Φᴿ = Φᴿ}
      {A = ＇ X} {B = ＇ Y} {C = `∀ A} C∈
route-vars-not-forall (route-vars C∈) | W , () , W<Δ , ok

route-var-star-not-forall :
  ∀ {fuel Φᴸ Φᴿ Δᶜ Δᴸ Δᴿ X A} →
  EnumRoute fuel Φᴸ Φᴿ Δᶜ Δᴸ Δᴿ
    (＇ X) ★ (`∀ A) →
  ⊥
route-var-star-not-forall
    {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {Δᶜ = Δᶜ}
    {X = X} {A = A} (route-var-star C∈)
    with var-candidate-member-shape
      {limit = Δᶜ} {Φᴸ = Φᴸ} {Φᴿ = Φᴿ}
      {A = ＇ X} {B = ★} {C = `∀ A} C∈
route-var-star-not-forall (route-var-star C∈)
    | W , () , W<Δ , ok

route-star-var-not-forall :
  ∀ {fuel Φᴸ Φᴿ Δᶜ Δᴸ Δᴿ Y A} →
  EnumRoute fuel Φᴸ Φᴿ Δᶜ Δᴸ Δᴿ
    ★ (＇ Y) (`∀ A) →
  ⊥
route-star-var-not-forall
    {Φᴸ = Φᴸ} {Φᴿ = Φᴿ} {Δᶜ = Δᶜ}
    {Y = Y} {A = A} (route-star-var C∈)
    with var-candidate-member-shape
      {limit = Δᶜ} {Φᴸ = Φᴸ} {Φᴿ = Φᴿ}
      {A = ★} {B = ＇ Y} {C = `∀ A} C∈
route-star-var-not-forall (route-star-var C∈)
    | W , () , W<Δ , ok
